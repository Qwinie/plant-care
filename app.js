...
const AIAdvisor = ({plant, apiKey}) => {
  ...
  const ask = async () => {
    ...
    // Try artifact API (no key needed when running inside Claude.ai)
    const tryFetch = async (headers) => {
      const r = await fetch("https://api.anthropic.com/v1/messages", {
        method:"POST", headers,
        body: JSON.stringify({model:"claude-sonnet-4-6", max_tokens:1000,
          system:buildSystemPrompt(), messages:msgs})
      });
      if (!r.ok) throw new Error(`${r.status}`);
      const d = await r.json();
      return _optionalChain([d, 'access', _53 => _53.content, 'optionalAccess', _54 => _54.map, 'call', _55 => _55(b=>b.text||""), 'access', _56 => _56.join, 'call', _57 => _57("")]) || "Geen antwoord.";
    };

    let answer = null;
    // Attempt 1: artifact API (works in Claude.ai context)
    try {
      answer = await tryFetch({"Content-Type":"application/json"});
    } catch(_e) {}

    // Attempt 2: user API key
    if (!answer && _optionalChain([apiKey, 'optionalAccess', _58 => _58.trim, 'call', _59 => _59()])) {
      try {
        answer = await tryFetch({
    ...
    // Attempt 3: offline smart fallback
    if (!answer) {
...
const PhotoGallery = ({plant, onUpdatePlant}) => {
  ...
  const savePhotos = (next) => {
    ...
    onUpdatePlant({
      ...
      photoUrl: _optionalChain([next, 'access', _60 => _60[0], 'optionalAccess', _61 => _61.url]) || null,
    });
    ...
    React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:16,marginBottom:12},}
      ...
      , photos.length > 0 && (React.createElement(React.Fragment, null
        , React.createElement('div', { style: {borderRadius:12,overflow:'hidden',marginBottom:8,position:'relative',
          ...
          , React.createElement('img', { src: _optionalChain([photos, 'access', _62 => _62[activeIdx], 'optionalAccess', _63 => _63.url]), alt: "plant",
...
const CareEventsPanel = ({plant, onUpdatePlant, season}) => {
  const sp = SPECIES_DB[plant.species];
  const category = _optionalChain([sp, 'optionalAccess', _64 => _64.category]) || "";
...
const CustomCareEditor = ({plant, onUpdatePlant, season}) => {
  const sp = SPECIES_DB[plant.species];
  const care = _optionalChain([sp, 'optionalAccess', _65 => _65.care, 'access', _66 => _66[season]]) || {};
  ...
  const fields = [
    ...
    {key:"sunlight_min", label:"☀️ Zon min", unit:"uur/dag", default: _optionalChain([sp, 'optionalAccess', _67 => _67.sunlight, 'access', _68 => _68.min]) || 3, min:0, max:24,
     hint:"Minimum zonuren per dag"},
    {key:"sunlight_max", label:"☀️ Zon max", unit:"uur/dag", default: _optionalChain([sp, 'optionalAccess', _69 => _69.sunlight, 'access', _70 => _70.max]) || 8, min:0, max:24,
          ...
          React.createElement('div', { key: k, style: {marginBottom:10},}
            , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:4},}
              , React.createElement('label', { style: {fontSize:11,fontWeight:600,color:C.muted},}
                , _optionalChain([def, 'optionalAccess', _71 => _71.icon]), " " , _optionalChain([def, 'optionalAccess', _72 => _72.label, 'optionalAccess', _73 => _73.toUpperCase, 'call', _74 => _74()]), _optionalChain([def, 'optionalAccess', _75 => _75.unit])?` (${def.unit})`:""
              )
          ...
          , pKeys.map(k=>{
            ...
            return(
              React.createElement('div', { key: k, style: {background:C.surfaceAlt,borderRadius:6,padding:"3px 8px",fontSize:12,color:C.text},}
                , React.createElement('span', null, _optionalChain([def, 'optionalAccess', _76 => _76.icon]), " " )
                , React.createElement('span', { style: {fontWeight:600},}, _optionalChain([def, 'optionalAccess', _77 => _77.label]), ": " )
...
const RepottingReminder = ({plant, onUpdatePlant}) => {
  ...
  const repotInfo = _optionalChain([sp, 'optionalAccess', _78 => _78.repot]) || "Elke 2 jaar";
...
const ASPCAToxicity = ({species, staticToxicity}) => {
  ...
  const lookup = async () => {
    ...
    try {
      ...
      rows.forEach(row => {
        const scientific = _optionalChain([row, 'access', _79 => _79.querySelector, 'call', _80 => _80(".field-content"), 'optionalAccess', _81 => _81.textContent, 'optionalAccess', _82 => _82.trim, 'call', _83 => _83()]) || "";
        const toxicStatus = _optionalChain([row, 'access', _84 => _84.querySelector, 'call', _85 => _85(".views-field-field-plant-tox-status"), 'optionalAccess', _86 => _86.textContent, 'optionalAccess', _87 => _87.trim, 'call', _88 => _88()]) || "";
        const animals = _optionalChain([row, 'access', _89 => _89.querySelector, 'call', _90 => _90(".views-field-field-plant-species-animals"), 'optionalAccess', _91 => _91.textContent, 'optionalAccess', _92 => _92.trim, 'call', _93 => _93()]) || "";
        const symptoms = _optionalChain([row, 'access', _94 => _94.querySelector, 'call', _95 => _95(".views-field-field-plant-species-clinical-signs"), 'optionalAccess', _96 => _96.textContent, 'optionalAccess', _97 => _97.trim, 'call', _98 => _98()]) || "";
        const name = _optionalChain([row, 'access', _99 => _99.querySelector, 'call', _100 => _100("h3, .views-field-title"), 'optionalAccess', _101 => _101.textContent, 'optionalAccess', _102 => _102.trim, 'call', _103 => _103()]) || "";
      ...
      if (found) {
        ...
        const pageText = _optionalChain([doc, 'access', _104 => _104.body, 'optionalAccess', _105 => _105.innerText]) || html;
...
const LichtMeter = ({plant, sunlight, onSaveReading, onClose}) => {
  ...
  // Cleanup on unmount
  useEffect(() => () => {
    _optionalChain([streamRef, 'access', _106 => _106.current, 'optionalAccess', _107 => _107.getTracks, 'call', _108 => _108(), 'access', _109 => _109.forEach, 'call', _110 => _110(t => t.stop())]);
    cancelAnimationFrame(rafRef.current);
    _optionalChain([sensorRef, 'access', _111 => _111.current, 'optionalAccess', _112 => _112.stop, 'optionalCall', _113 => _113()]);
  }, []);
  ...
  const saveReading = () => {
    if (lux === null) return;
    _optionalChain([onSaveReading, 'optionalCall', _114 => _114(lux, _optionalChain([zone, 'optionalAccess', _115 => _115.label]) || "")]);
    onClose();
  };
      ...
      , React.createElement('div', { style: {padding:"14px 16px",display:"flex",alignItems:"center",gap:12,
        ...
        , React.createElement('div', { style: {flex:1},}
          ...
          , plant && React.createElement('div', { style: {fontSize:11,color:"rgba(255,255,255,0.5)"},}, "voor "
             , plant.name, " · "  , _optionalChain([sunlight, 'optionalAccess', _116 => _116.min]), "–", _optionalChain([sunlight, 'optionalAccess', _117 => _117.max]), "u/dag vereist"
          )
        )
        , method === "sensor" && (
        ...
        React.createElement('div', { style: {flex:1,display:"flex",flexDirection:"column",overflow:"hidden"},}
          ...
          , React.createElement('div', { style: {flex:1,overflowY:"auto",padding:"20px 20px 0",textAlign:"center"},}
            ...
            , React.createElement('div', { style: {fontWeight:800,fontSize:18,color:"#fff",marginBottom:10},}, "Licht meten voor "
                 , _optionalChain([plant, 'optionalAccess', _118 => _118.name]) || "je plant"
            )
    ...
    React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.7)",zIndex:400,
      ...
      , React.createElement('div', { style: {background:C.surface,borderRadius:24,padding:24,width:"100%",maxWidth:360,
        ...
        , React.createElement('div', { id: `qr-card-${plant.id}`, style: {background:"#fff",borderRadius:16,padding:16,
          ...
          , _optionalChain([sp, 'optionalAccess', _119 => _119.toxicity]) && !/non[\-\s]toxic/i.test(sp.toxicity) && (
...
const QRScanner = ({plants, onFound, onClose}) => {
  ...
  useEffect(() => {
    let animFrame;
    _optionalChain([navigator, 'access', _120 => _120.mediaDevices, 'optionalAccess', _121 => _121.getUserMedia, 'call', _122 => _122({video:{facingMode:"environment"}})
, 'access', _123 => _123.then, 'call', _124 => _124(stream => {
        streamRef.current = stream;
        if (videoRef.current) {
          videoRef.current.srcObject = stream;
...
, 'access', _125 => _125.catch, 'call', _126 => _126(() => setError("Geen cameratoegang. Controleer je browserinstellingen."))]);
    return () => {
      cancelAnimationFrame(animFrame);
      _optionalChain([streamRef, 'access', _127 => _127.current, 'optionalAccess', _128 => _128.getTracks, 'call', _129 => _129(), 'access', _130 => _130.forEach, 'call', _131 => _131(t=>t.stop())]);
    };
  }, []);
...
const PDFExport = ({plants, logs, onClose}) => {
  ...
  const printReport = () => {
    ...
    const rows = exportPlants.map(p => {
      ...
      const lastWater = plantLogs.find(l=>_optionalChain([l, 'access', _132 => _132.parameters, 'optionalAccess', _133 => _133.watering]));
      const toxic = _optionalChain([sp, 'optionalAccess', _134 => _134.toxicity]) && !/non[\-\s]toxic/i.test(sp.toxicity);
      return `
        <div class="plant-card">
          ...
          <div class="info-grid">
            ...
            ${sp?`<div class="info-item"><span class="label">Waterfrequentie</span><span>${_optionalChain([sp, 'access', _135 => _135.care, 'access', _136 => _136.summer, 'optionalAccess', _137 => _137.water])} dagen (zomer)</span></div>`:""}
          ...
          ${_optionalChain([p, 'access', _138 => _138.soilMix, 'optionalAccess', _139 => _139.length])?`<div class="soil-mix"><strong>Grondmengsel:</strong> ${p.soilMix.map(m=>`${m.pct}% ${m.name}`).join(", ")}</div>`:""}
        ...
        , React.createElement('div', { style: {overflowY:"auto",flex:1,padding:"14px 20px"},}
          ...
          , plants.map(p=>(
            React.createElement('button', { key: p.id, onClick: ()=>toggle(p.id),
              ...
              , React.createElement(ToxicityBadge, { toxicity: _optionalChain([SPECIES_DB, 'access', _140 => _140[p.species], 'optionalAccess', _141 => _141.toxicity]), small: true,})
            )
          ))
        )
        , React.createElement('div', { style: {padding:"12px 20px",borderTop:`1px solid ${C.border}`,display:"flex",gap:10},}
...
const PlantDetail = ({plant,logs,sections,onAddSection,onBack,onUpdatePlant,onAddLog,onDeleteLog,onUpdateLog,onDelete,t,apiKey}) => {
  ...
  useEffect(()=>{
    ...
    const check=()=>{
      ...
      if(e && _optionalChain([e, 'access', _142 => _142.care, 'optionalAccess', _143 => _143.spring, 'optionalAccess', _144 => _144.water]) && (!dbEntry || !_optionalChain([dbEntry, 'access', _145 => _145.care, 'optionalAccess', _146 => _146.spring, 'optionalAccess', _147 => _147.water]))) {
        setDbEntry(e);
      }
    };
    check();
  ...
  const userPhotoUrl = _optionalChain([(plant.photos || []), 'access', _148 => _148[0], 'optionalAccess', _149 => _149.url]) || null;
  ...
  useEffect(() => {
    ...
    const up = _optionalChain([(plant.photos || []), 'access', _150 => _150[0], 'optionalAccess', _151 => _151.url]) || null;
  ...
  const emoji=_optionalChain([sp, 'optionalAccess', _152 => _152.image])||"🌿";
  ...
  return(
    React.createElement('div', { style: {minHeight:"100vh",background:C.bg,fontFamily:"system-ui,sans-serif"},}
      ...
      , waterPaused ? (
        React.createElement('div', { style: {background:C.warning,padding:"10px 20px",display:"flex",justifyContent:"space-between",alignItems:"center"},}
          , React.createElement('span', { style: {color:"#fff",fontWeight:700,fontSize:14},}, "⚡ "
             , _optionalChain([pausedEvt, 'optionalAccess', _153 => _153.icon]), " Gepauzeerd — "   , _optionalChain([pausedEvt, 'optionalAccess', _154 => _154.label])
          )
          , React.createElement('span', { style: {color:"rgba(255,255,255,0.8)",fontSize:12},}, "nog "
             , Math.ceil((new Date(_optionalChain([pausedEvt, 'optionalAccess', _155 => _155.endDate]))-new Date())/86400000), " dagen"
          )
        )
      ) : days!==null&&(
        React.createElement('div', { style: {background:urgColor(days),padding:"10px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",gap:8},}
          , React.createElement('span', { style: {color:"#fff",fontWeight:700,fontSize:13,flex:1},}
            , days<=0?(_optionalChain([t, 'optionalAccess', _156 => _156.waterToday])||"💧 Water vandaag!"):days===1?(_optionalChain([t, 'optionalAccess', _157 => _157.waterTomorrow])||"💧 Water morgen"):`${_optionalChain([t, 'optionalAccess', _158 => _158.waterIn])||"💧 Water over"} ${days} ${days===1?(_optionalChain([t, 'optionalAccess', _159 => _159.day])||"dag"):(_optionalChain([t, 'optionalAccess', _160 => _160.days])||"dagen")}`
          )
          ...
          , React.createElement('button', { onClick: handleWatered,
            ...
            , _optionalChain([t, 'optionalAccess', _161 => _161.markWatered])||"✓ Water gegeven"
          )
        )
      )
      ...
      , React.createElement('div', { style: {display:"flex",borderBottom:`2px solid ${C.border}`,background:C.surface},}
        , [
          {id:"overview", label:_optionalChain([t, 'optionalAccess', _162 => _162.overview])||"Overzicht",  icon:"🏠"},
          {id:"seasons",  label:_optionalChain([t, 'optionalAccess', _163 => _163.seasons])||"Seizoenen",   icon:"🗓"},
          {id:"care",     label:_optionalChain([t, 'optionalAccess', _164 => _164.care])||"Verzorging",     icon:"🌿"},
          {id:"log",      label:`${_optionalChain([t, 'optionalAccess', _165 => _165.log])||"Log"} (${plantLogs.length})`, icon:"📝"},
        ].map(tb=>(
      ...
      , React.createElement('div', { style: {padding:16,maxWidth:600,margin:"0 auto",paddingBottom:40},}
        ...
        , tab==="overview"&&(
          React.createElement(React.Fragment, null
            ...
            , React.createElement(CollapsibleCard, {
              ...
              badge: _optionalChain([plant, 'access', _166 => _166.expertNotes, 'optionalAccess', _167 => _167.trim, 'call', _168 => _168()])?"Expert advies":null,
              urgent: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            , React.createElement(CollapsibleCard, {
              ...
              , sp ? (
                React.createElement('div', { style: {paddingTop:12},}
                  ...
                  , _optionalChain([care, 'access', _169 => _169.expertBullets, 'optionalAccess', _170 => _170.length]) > 0 && (
            ...
            , React.createElement(CollapsibleCard, { icon: "🤖", title: "AI Plant Advisor"  ,
              defaultOpen: false,
              badge: _optionalChain([care, 'access', _171 => _171.expertBullets, 'optionalAccess', _172 => _172.length])>0?`📋 ${care.expertBullets.length} tips`:null,}
              , React.createElement('div', { style: {paddingTop:12},}
        ...
        , tab==="seasons"&&(React.createElement(React.Fragment, null
          ...
          , SEASONS.map(s=>{
            ...
            const spCare = _optionalChain([sp, 'optionalAccess', _173 => _173.care, 'access', _174 => _174[s]]) || {water:7, humidity:50, notes:""};
            const custom = plant.customCare || {};
        ...
        , tab==="log"&&(React.createElement(React.Fragment, null
          ...
          , (() => {
            const healthPoints = plantLogs
              .filter(l => _optionalChain([l, 'access', _175 => _175.parameters, 'optionalAccess', _176 => _176.health_score]) !== undefined)
              .map(l => ({date:l.timestamp.split("T")[0], val:l.parameters.health_score}))
              .sort((a,b)=>a.date.localeCompare(b.date));
            const heightPoints = plantLogs
              .filter(l => _optionalChain([l, 'access', _177 => _177.parameters, 'optionalAccess', _178 => _178.height]) !== undefined)
          ...
          , (() => {
            const waterLogs = plantLogs.filter(l => _optionalChain([l, 'access', _179 => _179.parameters, 'optionalAccess', _180 => _180.watering]) !== undefined);
  ...
  try {
    ...
    const results = (Array.isArray(data) ? data : data.results || [])
      ...
      .map(s => ({
        ...
        commonName: _optionalChain([s, 'access', _181 => _181.vernacularNames, 'optionalAccess', _182 => _182[0], 'optionalAccess', _183 => _183.vernacularName]) || s.canonicalName,
    ...
    return (data2.results || [])
      ...
      .map(s => ({
        scientificName: s.canonicalName,
        commonName: _optionalChain([s, 'access', _184 => _184.vernacularNames, 'optionalAccess', _185 => _185[0], 'optionalAccess', _186 => _186.vernacularName]) || s.canonicalName,
        family: s.family || "",
        fromDB: !!SPECIES_DB[s.canonicalName],
      }));
  } catch (e) {
...
const fetchWikiPhoto = async (speciesName) => {
  try {
    ...
    const title = _optionalChain([sd, 'optionalAccess', _187 => _187.query, 'optionalAccess', _188 => _188.search, 'optionalAccess', _189 => _189[0], 'optionalAccess', _190 => _190.title]);
    ...
    const pages = _optionalChain([id, 'optionalAccess', _191 => _191.query, 'optionalAccess', _192 => _192.pages]);
    const page = pages ? Object.values(pages)[0] : null;
    return _optionalChain([page, 'optionalAccess', _193 => _193.thumbnail, 'optionalAccess', _194 => _194.source]) || null;
...
const fetchAndStoreSpeciesData = async (scientificName, commonName, family) => {
  ...
  if (existing && _optionalChain([existing, 'access', _195 => _195.care, 'optionalAccess', _196 => _196.spring, 'optionalAccess', _197 => _197.water])) return existing;
...
{"commonName":"string","family":"string","category":"Cacti|Succulents|Aroids|Ferns|Palms|Orchids|Bromeliads|Tropical Foliage|Herbs|Carnivorous|Climbing / Trailing|Flowering|Indoor Trees|Other","origin":"string","image":"emoji","careLevel":"Easy|Medium|Hard","description":"2-3 sentences","care":{"spring":{"water":10,"humidity":40,"notes":"spring advice"},"summer":{"water":7,"humidity":45,"notes":"summer advice"},"autumn":{"water":14,"humidity":35,"notes":"autumn advice"},"winter":{"water":21,"humidity":30,"notes":"winter advice"}},"sunlight":{"min":4,"max":8,"type":"light description","uv":"Low|Medium|High|Very High"},"temp":{"min":5,"max":35,"ideal":"15-28°C"},"soil":"soil description","pot":"pot description","fertilize":"fertilizing info","repot":"repotting info","toxicity":"toxicity info","propagation":"propagation method","tips":["tip 1","tip 2","tip 3"]}`;
  ...
  try {
    ...
    let text = (_optionalChain([data, 'access', _198 => _198.content, 'optionalAccess', _199 => _199.map, 'call', _200 => _200(b => b.text || ""), 'access', _201 => _201.join, 'call', _202 => _202("")]) || "").trim();
    ...
    if (!_optionalChain([entry, 'access', _203 => _203.care, 'optionalAccess', _204 => _204.spring, 'optionalAccess', _205 => _205.water])) { console.warn("Incomplete entry:", entry); return null; }
...
const reverseGeocode = async (lat, lon) => {
  try {
    ...
    const d = await r.json();
    return {
      city:    _optionalChain([d, 'access', _206 => _206.address, 'optionalAccess', _207 => _207.city]) || _optionalChain([d, 'access', _208 => _208.address, 'optionalAccess', _209 => _209.town]) || _optionalChain([d, 'access', _210 => _210.address, 'optionalAccess', _211 => _211.village]) || _optionalChain([d, 'access', _212 => _212.address, 'optionalAccess', _213 => _213.county]) || "",
      country: _optionalChain([d, 'access', _214 => _214.address, 'optionalAccess', _215 => _215.country]) || "",
      countryCode: _optionalChain([d, 'access', _216 => _216.address, 'optionalAccess', _217 => _217.country_code, 'optionalAccess', _218 => _218.toUpperCase, 'call', _219 => _219()]) || "",
...
const fetchINaturalist = async (speciesName) => {
  try {
    ...
    if (!r.ok) return null;
    const d = await r.json();
    const taxon = _optionalChain([d, 'access', _220 => _220.results, 'optionalAccess', _221 => _221[0]]);
    ...
    return {
      ...
      status:       _optionalChain([taxon, 'access', _222 => _222.conservation_status, 'optionalAccess', _223 => _223.status_name]) || null,
    };
  } catch(_e) { return null; }
};
...
const fetchLocationAwareCareData = async (scientificName, commonName, family, onProgress) => {
  ...
  entry._sources = {
    weather:     !!weather,
    wikipedia:   !!_optionalChain([wiki, 'optionalAccess', _224 => _224.extract]),
    inaturalist: !!inat,
...
const buildCareFromSources = (scientificName, commonName, family, wiki, inat, location, weather) => {
  ...
  const name = (scientificName + " " + (commonName||"") + " " + (family||"") + " " + (_optionalChain([wiki, 'optionalAccess', _225 => _225.extract])||"")).toLowerCase();
  ...
  const localHumidity = _optionalChain([weather, 'optionalAccess', _226 => _226.current, 'optionalAccess', _227 => _227.humidity]) || 60;
  const localTemp = _optionalChain([weather, 'optionalAccess', _228 => _228.current, 'optionalAccess', _229 => _229.temp]) || 15;
  ...
  const extract = _optionalChain([wiki, 'optionalAccess', _230 => _230.extract]) || "";
  ...
  return {
    ...
    category,
    origin: extractOrigin(_optionalChain([wiki, 'optionalAccess', _231 => _231.extract]) || "", inat),
    image: emoji,
    ...
    tips: [
      ...
      inat ? `${_optionalChain([inat, 'access', _232 => _232.observations, 'optionalAccess', _233 => _233.toLocaleString, 'call', _234 => _234()]) || "Duizenden"} waarnemingen wereldwijd op iNaturalist.` : "Controleer regelmatig op plagen.",
    ],
...
Wikipedia says: "${(_optionalChain([wiki, 'optionalAccess', _235 => _235.extract]) || "").slice(0, 400)}"
...
{"care":{"spring":{"water":N,"humidity":N,"notes":"string"},"summer":{"water":N,"humidity":N,"notes":"string"},"autumn":{"water":N,"humidity":N,"notes":"string"},"winter":{"water":N,"humidity":N,"notes":"string"}},"tips":["tip1","tip2","tip3"],"locationNote":"1 sentence about growing in ${locCity}"}`;
  ...
  let text = (_optionalChain([data, 'access', _236 => _236.content, 'optionalAccess', _237 => _237.map, 'call', _238 => _238(b => b.text||""), 'access', _239 => _239.join, 'call', _240 => _240("")])||"").trim();
  text = text.replace(/^```(?:json)?\s*/i,"").replace(/\s*```\s*$/i,"").trim();
  const s = text.indexOf("{"), e = text.lastIndexOf("}");
  if (s === -1) return null;
  const patch = JSON.parse(text.slice(s, e+1));
  // Only apply valid patches
  if (_optionalChain([patch, 'access', _241 => _241.care, 'optionalAccess', _242 => _242.spring, 'optionalAccess', _243 => _243.water])) Object.assign(baseEntry.care, patch.care);
  if (_optionalChain([patch, 'access', _244 => _244.tips, 'optionalAccess', _245 => _245.length])) baseEntry.tips = patch.tips;
...
const RefreshCareData = ({plant, onUpdatePlant}) => {
  const sp = SPECIES_DB[plant.species];
  const sources = _optionalChain([sp, 'optionalAccess', _246 => _246._sources]);
  ...
  const run = async () => {
    ...
    if (SPECIES_DB[plant.species] && !_optionalChain([SPECIES_DB, 'access', _247 => _247[plant.species], 'optionalAccess', _248 => _248.care, 'optionalAccess', _249 => _249.spring, 'optionalAccess', _250 => _250.water])) {
    ...
    const out = await fetchLocationAwareCareData(
      plant.species,
      _optionalChain([existingEntry, 'optionalAccess', _251 => _251.commonName]) || plant.species,
      _optionalChain([existingEntry, 'optionalAccess', _252 => _252.family]) || "",
    ...
    if (out) {
      ...
      const season = getCurrentSeason();
      const newInterval = _optionalChain([out, 'access', _253 => _253.entry, 'optionalAccess', _254 => _254.care, 'optionalAccess', _255 => _255[season], 'optionalAccess', _256 => _256.water]) || 7;
  ...
  return (
    React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:16,marginBottom:12,
      ...
      , _optionalChain([sources, 'optionalAccess', _257 => _257.locationNote]) && (
  ...
  const search = useCallback(async (q) => {
    ...
    const localMatches = Object.entries(SPECIES_DB)
      .filter(([k, v]) =>
        ...
        _optionalChain([v, 'access', _258 => _258.commonName, 'optionalAccess', _259 => _259.toLowerCase, 'call', _260 => _260(), 'access', _261 => _261.includes, 'call', _262 => _262(ql)]) ||
        _optionalChain([v, 'access', _263 => _263.family, 'optionalAccess', _264 => _264.toLowerCase, 'call', _265 => _265(), 'access', _266 => _266.includes, 'call', _267 => _267(ql)]) ||
        _optionalChain([v, 'access', _268 => _268.category, 'optionalAccess', _269 => _269.toLowerCase, 'call', _270 => _270(), 'access', _271 => _271.includes, 'call', _272 => _272(ql)])
      )
...
const AddPlantModal = ({onAdd, sections, onClose}) => {
  ...
  useEffect(() => {
    ...
    if (!name) setName(_optionalChain([selected, 'access', _273 => _273.commonName, 'optionalAccess', _274 => _274.split, 'call', _275 => _275(" "), 'access', _276 => _276[0]]) || "");
  }, [_optionalChain([selected, 'optionalAccess', _277 => _277.scientificName])]);
  ...
  const handleAdd = async () => {
    ...
    if (!SPECIES_DB[selected.scientificName]) {
      ...
      try {
        ...
        entry = _optionalChain([result, 'optionalAccess', _278 => _278.entry]) || null;
      } catch(_e) {}
      if (!entry) {
        ...
        , React.createElement('div', { style: {overflowY:"auto",flex:1,padding:"0 20px"},}
          ...
          , results.length>0&&!selected&&results.map(r=>(
            React.createElement('div', { key: r.scientificName, onClick: ()=>setSelected(r),
              ...
              , React.createElement('div', { style: {fontSize:28,width:40,textAlign:"center",flexShrink:0},}, _optionalChain([SPECIES_DB, 'access', _279 => _279[r.scientificName], 'optionalAccess', _280 => _280.image])||"🌿")
              , React.createElement('div', { style: {flex:1,minWidth:0},}
            ...
            React.createElement('div', null
              ...
              , React.createElement('div', { style: {display:"flex",gap:14,marginBottom:16,alignItems:"flex-start"},}
                , React.createElement('div', { style: {width:110,height:110,borderRadius:14,overflow:"hidden",background:C.surfaceAlt,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,position:"relative"},}
                  , loadingPhoto?(React.createElement('div', { style: {textAlign:"center"},}, React.createElement('div', { style: {fontSize:36},}, _optionalChain([sp, 'optionalAccess', _281 => _281.image])||"🌿"), React.createElement('div', { style: {fontSize:9,color:C.muted,marginTop:4},}, "Laden…")))
                  ...
                  :(React.createElement('div', { style: {textAlign:"center"},}, React.createElement('div', { style: {fontSize:40},}, _optionalChain([sp, 'optionalAccess', _282 => _282.image])||"🌿"), React.createElement('div', { style: {fontSize:9,color:C.muted,marginTop:2},}, "Geen foto" )))
                )
                , React.createElement('div', { style: {flex:1},}
        ...
        if (daysLeft <= 0) {
          ...
          if (settings.missedWateringAlert) {
            sendNotification(
              ...
              `${name} (${_optionalChain([sp, 'optionalAccess', _283 => _283.commonName]) || plant.species}) had ${Math.abs(daysLeft)} dag${Math.abs(daysLeft)!==1?"en":""} geleden water moeten krijgen.`,
              `water_${plant.id}`
            );
...
const PlantCard = ({plant, logs, onSelect, sections, onQuickWater, isSelected, bulkMode}) => {
  ...
  const emoji = _optionalChain([sp, 'optionalAccess', _284 => _284.image]) || "🌿";
      ...
      , React.createElement('div', { onClick: ()=>onSelect(plant),
        ...
        , React.createElement('div', { style: {flex:1,minWidth:0},}
          , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:6},}
            ...
            , _optionalChain([SPECIES_DB, 'access', _285 => _285[plant.species], 'optionalAccess', _286 => _286.toxicity]) && !/non[\-\s]toxic/i.test(SPECIES_DB[plant.species].toxicity) && (
          ...
          , waterPaused ? (
            React.createElement('div', { style: {background:C.warning+"18",borderRadius:8,padding:"4px 6px"},}
              ...
              , React.createElement('div', { style: {fontSize:13,color:C.warning,fontWeight:800,lineHeight:1.2},}
                , Math.ceil((new Date(_optionalChain([pausedEvent, 'optionalAccess', _287 => _287.endDate]))-new Date())/86400000), "d"
              )
            )
          ) : snoozed ? (
  ...
  const handleImport = (e) => {
    ...
    reader.onload = (ev) => {
      try {
        ...
        onImport(data);
        setImportMsg({type:"ok", text:`✅ ${data.plants.length} planten en ${_optionalChain([data, 'access', _288 => _288.logs, 'optionalAccess', _289 => _289.length])||0} logs geïmporteerd.`});
      } catch(err) {
        ...
        , tab === "general" && (
          React.createElement('div', null
            ...
            , React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:14,marginBottom:12,
              ...
              , React.createElement('div', { style: {fontSize:13,color:C.muted,marginBottom:10,lineHeight:1.5},}, "Voer je Anthropic API-sleutel in om de AI Adviseur te gebruiken. Gratis aan te maken op"
                               , " "
                , React.createElement('span', { style: {color:C.sky,textDecoration:"underline",cursor:"pointer"},
                  onClick: ()=>window.open("https://console.anthropic.com"),}, "console.anthropic.com"), "."
              )
              , React.createElement('div', { style: {position:"relative"},}
                , React.createElement('input', { type: "password", value: apiKey||"", onChange: e=>onSetApiKey(e.target.value),
                  placeholder: "sk-ant-api03-...",
                  style: {width:"100%",border:`1.5px solid ${apiKey?C.green:C.border}`,
                    borderRadius:10,padding:"10px 44px 10px 12px",fontSize:13,
                    outline:"none",fontFamily:"inherit",boxSizing:"border-box"},})
                , apiKey&&React.createElement('span', { style: {position:"absolute",right:12,top:"50%",
                  transform:"translateY(-50%)",fontSize:16},}, "✅")
              )
              , apiKey
                ? React.createElement('div', { style: {fontSize:11,color:C.green,marginTop:6,fontWeight:600},}, "✅ Actief — AI Adviseur werkt"     )
                : React.createElement('div', { style: {fontSize:11,color:C.muted,marginTop:6},}, "Zonder sleutel toont de AI Adviseur een foutmelding."       )
            ...
            , React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:16,marginBottom:12},}
              ...
              , [
                ["Planten met foto", plants.filter(p=>p.photoUrl||_optionalChain([p, 'access', _290 => _290.photos, 'optionalAccess', _291 => _291.length])).length],
                ["Planten met zorgdata", plants.filter(p=>_optionalChain([SPECIES_DB, 'access', _292 => _292[p.species], 'optionalAccess', _293 => _293.care])).length],
                ...
                ["Logs deze maand", logs.filter(l=>_optionalChain([l, 'access', _294 => _294.timestamp, 'optionalAccess', _295 => _295.startsWith, 'call', _296 => _296(new Date().toISOString().slice(0,7))])).length],
              ].map(([label,val])=>(
...
const Dashboard = ({plants, logs, sections, estates, activeEstate, onSelectPlant, onAddPlant, onDeletePlant, onOpenSettings, onQuickWater, t, bulkMode, selectedPlants, onToggleBulk, onBulkWater, onBulkMove, allSections, onOpenScanner}) => {
  ...
  const displayed = useMemo(() => {
    ...
    if (filterMode === "category" && filterCat !== "Alle")
      list = list.filter(p => _optionalChain([SPECIES_DB, 'access', _297 => _297[p.species], 'optionalAccess', _298 => _298.category]) === filterCat);
  ...
  const usedCats = [...new Set(plants.map(p => _optionalChain([SPECIES_DB, 'access', _299 => _299[p.species], 'optionalAccess', _300 => _300.category])).filter(Boolean))].sort();
    ...
    React.createElement('div', { style: {minHeight:"100vh",background:C.bg,fontFamily:"system-ui,sans-serif",paddingBottom:80},}
      ...
      , React.createElement('div', { style: {background:`linear-gradient(160deg, ${C.soil} 0%, ${C.soilLight} 60%, #3A2E1A 100%)`,
        ...
        , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"flex-start",position:"relative"},}
          , React.createElement('div', null
            , React.createElement('div', { style: {fontSize:10,color:C.sand,letterSpacing:3,textTransform:"uppercase",
              ...
              , React.createElement('span', null, (_optionalChain([t, 'optionalAccess', _301 => _301.seasons])||season).charAt(0).toUpperCase()+(_optionalChain([t, 'optionalAccess', _302 => _302.seasons])||season).slice(1), " " , new Date().getFullYear())
            )
            , React.createElement('div', { style: {fontSize:10,color:"rgba(255,255,255,0.5)",marginBottom:2,
              display:"flex",alignItems:"center",gap:4},}
              , React.createElement('span', null, _optionalChain([activeEstate, 'optionalAccess', _303 => _303.icon])||"🌿")
              , React.createElement('span', { style: {letterSpacing:1,textTransform:"uppercase",fontWeight:600},}
                , _optionalChain([activeEstate, 'optionalAccess', _304 => _304.name])||"Mijn Tuin"
              )
            )
            ...
            , React.createElement('div', { style: {fontSize:12,color:C.greenLight,marginTop:4,fontWeight:500,
              ...
              , React.createElement('button', { onClick: onOpenSettings,
                ...
                , _optionalChain([t, 'optionalAccess', _305 => _305.switchLocation])||"+ Locatie wisselen"
              )
            )
          )
        ...
        , React.createElement('div', { style: {display:"flex",gap:8,marginTop:16,position:"relative"},}
          , [
            {label:_optionalChain([t, 'optionalAccess', _306 => _306.waterNow])||"Water nu",val:urgent.length,color:urgent.length?"#FF8A80":C.greenLight,
             bg:urgent.length?"rgba(184,92,66,0.25)":"rgba(255,255,255,0.08)",
             icon:"💧"},
            {label:_optionalChain([t, 'optionalAccess', _307 => _307.soon])||"Binnenkort",val:soon.length,color:soon.length?"#FFD54F":C.greenLight,
             bg:soon.length?"rgba(212,150,14,0.2)":"rgba(255,255,255,0.08)",
             icon:"⏳"},
            {label:_optionalChain([t, 'optionalAccess', _308 => _308.avgHealth])||"Gem. gezondheid",
          ...
          React.createElement('div', { className: "pca-fade", style: {background:`linear-gradient(135deg, ${C.terracottaLight}, #F5D0C4)`,
            ...
            , urgent.map(p=>(
              React.createElement('div', { key: p.id, onClick: ()=>onSelectPlant(p),
                ...
                , React.createElement('strong', null, p.name)
                , React.createElement('span', { style: {color:C.muted,fontSize:11},}, "(", _optionalChain([SPECIES_DB, 'access', _309 => _309[p.species], 'optionalAccess', _310 => _310.commonName])||p.species, ")")
            ...
            , ["Alle",...sections.map(s=>s.name)].map(name=>{
              ...
              return (
                React.createElement('button', { key: name, onClick: ()=>setFilterSection(name),
                  style: {padding:"5px 12px",borderRadius:20,border:`1px solid ${active?(_optionalChain([s, 'optionalAccess', _311 => _311.color])||C.green):C.border}`,
                    background:active?(_optionalChain([s, 'optionalAccess', _312 => _312.color])||C.green)+"22":"none",
                    color:active?(_optionalChain([s, 'optionalAccess', _313 => _313.color])||C.green):C.muted,
        ...
        , showGrouped && groupedPlants ? (
              ...
              , sPlants.map((plant, idx) => (
                React.createElement('div', { key: plant.id, style: {animationDelay:`${idx*40}ms`},}
                  , React.createElement(PlantCard, { plant: plant, logs: logs, sections: sections,
                    ...
                    isSelected: _optionalChain([selectedPlants, 'optionalAccess', _314 => _314.includes, 'call', _315 => _315(plant.id)]), bulkMode: bulkMode,})
                )
              ))
            )
          ))
          ...
          displayed.length === 0 ? (
                ...
                React.createElement('div', { key: plant.id, style: {animationDelay:`${idx*40}ms`},}
                  , React.createElement(PlantCard, { plant: plant, logs: logs, sections: sections,
                    onSelect: onSelectPlant, onQuickWater: onQuickWater,
                    isSelected: _optionalChain([selectedPlants, 'optionalAccess', _316 => _316.includes, 'call', _317 => _317(plant.id)]), bulkMode: bulkMode,})
                )
              ))
        )
      )
...
function PlantCareApp() {
  ...
  useEffect(() => {
    ...
    const missingAddedLogs = plants.filter(plant => {
      ...
      const hasAddedLog = logs.some(l =>
        l.plantId === plant.id &&
        l.auto === true &&
        _optionalChain([l, 'access', _318 => _318.notes, 'optionalAccess', _319 => _319.includes, 'call', _320 => _320("toegevoegd aan de collectie")])
      );
      return !hasAddedLog;
    });
  ...
  const quickWater = useCallback((plant) => {
    const season = getCurrentSeason();
    const care = _optionalChain([SPECIES_DB, 'access', _321 => _321[plant.species], 'optionalAccess', _322 => _322.care, 'access', _323 => _323[season]]);
    const interval = _nullishCoalesce(_nullishCoalesce(_optionalChain([plant, 'access', _324 => _324.customCare, 'optionalAccess', _325 => _325[`water_${season}`]]), () => ( _optionalChain([care, 'optionalAccess', _326 => _326.water]))), () => ( 7));
    const today = new Date().toISOString().split("T")[0];
  ...
  const deleteSection=useCallback(id=>{
    ...
    setPlants(prev=>prev.map(p=>p.section===_optionalChain([sections, 'access', _327 => _327.find, 'call', _328 => _328(s=>s.id===id), 'optionalAccess', _329 => _329.name])?{...p,section:""}:p));
  },[sections]);
  ...
  return(React.createElement(React.Fragment, null
    ...
    , showSettings
      ? React.createElement(SettingsScreen, {
          ...
          estates: estates, activeEstateId: activeEstateId,
          onAddEstate: (name,icon)=>{const e={id:uid(),name,icon};setEstates(prev=>[...prev,e]);setActiveEstateId(e.id);},
          onDeleteEstate: id=>{setEstates(prev=>prev.filter(e=>e.id!==id));if(activeEstateId===id)setActiveEstateId(_optionalChain([estates, 'access', _330 => _330.find, 'call', _331 => _331(e=>e.id!==id), 'optionalAccess', _332 => _332.id])||"");},
