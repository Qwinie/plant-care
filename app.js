...
const T = {
  nl: {
    ...
    addLocation:"+ Nieuwe locatie", manageLocations:"Locaties beheren",
    locations:"Locaties", addNewLocation:"+ Nieuwe locatie toevoegen",
    locationName:"Naam van locatie...", activeLabel:"Actief",
    urgentTitle:"Water nu nodig", overdue:"Te laat", today:"Vandaag",
    settings:"Instellingen", back:"← Terug", save:"Opslaan",
    addPlant:"+ Plant toevoegen", searchPlant:"🔍  Zoek plant of soort...",
    waterSchedule:"Waterschema", lastWatered:"Laatst water gegeven",
    nextWater:"Volgende waterbeurt", health:"Gezondheid",
    photos:"Foto's", addPhoto:"+ Foto toevoegen",
    fertilizer:"Bemesting", repot:"Verpotten", pest:"Plaag",
    export:"📤 Download backup", import:"📥 Kies backup bestand",
    importing:"⏳ Importeren...",
    deleteAll:"🗑️ Wis alle data", deleteConfirm:"Weet je zeker dat je ALLE data wilt verwijderen? Dit kan niet ongedaan worden gemaakt.",
    privacy:"🔒 Privacy", privacyView:"📋 Privacybeleid bekijken", privacyClose:"▲ Privacybeleid sluiten",
    darkMode:"🌙 Weergave", darkModeOn:"Donkere modus actief", lightModeOn:"Lichte modus actief",
    lightBtn:"☀️ Licht", darkBtn:"🌙 Donker",
    vacation:"🏖️ Vakantie-modus", vacationDesc:"Pauzeer waterschema\'s tijdens afwezigheid",
    vacationActive:"Actief", vacationActivate:"Activeer", vacationDeactivate:"Deactiveer",
    caretaker:"Naam verzorger (optioneel)", caretakerNotes:"Extra notities voor de verzorger...",
    pdfCaretaker:"📄 PDF genereren voor verzorger",
    from:"VAN", to:"TOT",
    streak:"verzorgingen op rij",
    waterFilter:"Water", pestFilter:"Plagen", fertFilter:"Bemesting", growthFilter:"Groei", allFilter:"Alles",
    dataTab:"💾 Data exporteren / importeren",
    scanQR:"📱 QR Scanner", generateQR:"QR-code tonen",
    lightMeter:"☀️ Lichtmeter", aiAdvisor:"🤖 AI Plant Adviseur",
    tabGeneral:"Algemeen", tabTaal:"Taal", tabSections:"Afdelingen", tabNotif:"Meldingen", tabData:"Data",
    waterGiven: '💧 Water gegeven',
    waterToday2: '💧 Water vandaag!',
    waterTmrw: '💧 Water morgen',
    waterIn2: '💧 Water over',
    waterEvery: 'Water elke',
    waterLog30: '💧 Water gegeven — afgelopen 30 dagen',
    waterCount: '× water gegeven in 30 dagen',
    waterOrder: '💧 WATERSCHEMA VOLGORDE',
    waterNowCare: '💧☀️ Verzorging nu',
    snooze: '⏰ Uitstellen',
    paused: '⚡ Gepauzeerd',
    pausedDash: ' Gepauzeerd — ',
    eventActive: '⚡ Event actief',
    dag: 'dag',
    dagen: 'dagen',
    still: 'nog ',
    today2: 'Vandaag',
    healthTitle: '❤️ Gezondheid',
    healthPhotos: '❤️ Gezondheid + Fotos',
    healthy: 'Gezond',
    ideal: 'Ideaal',
    moderate: 'Matig',
    sick: 'Ziek',
    points: ' punten',
    careNow: '💧☀️ Verzorging nu',
    humidity: 'Luchtvochtigheid',
    humidityShort: 'Luchtvocht.',
    sun: 'Zon',
    perDay: 'u/dag',
    max: 'Max',
    min2: 'Min',
    noSeasonData: 'Geen seizoensdata',
    noSeasonNotes: 'Geen seizoensnotities beschikbaar.',
    noCareData: 'Geen verzorgingsdata',
    needed: 'Nodig!',
    proTips: '💡 Pro Tips',
    expertAdvice: 'Expert advies',
    breederAdvice: 'KWEKERIJ — SPECIFIEK ADVIES',
    warning: 'LET OP',
    locationIcon: '📍 Locatie',
    sectionIcon: '📂 Afdeling',
    notesIcon: '📝 Notities',
    heightIcon: '📏 Hoogte (cm)',
    qrGenerate: '📱 QR-code genereren',
    changeSpecies: "🔄 Soort wijzigen (behoudt logs + foto's)",
    personalNotes: 'Persoonlijke notities...',
    customSpecies: 'Eigen soort',
    careLog: 'Care Log',
    noEntries: 'Nog geen entries.',
    noCareYet: 'Nog geen verzorgingsdata.',
    useQuickLog: 'Gebruik Snel Loggen op het Overzicht tabblad.',
    evolution: '📈 Evolutie over tijd',
    pestDisease: 'Plaag / Ziekte',
    measureLight: 'Meet hoeveel licht er op de standplaats van ',
    getLocation: '🌍 Ophalen op mijn locatie',
    luxUnit: ' lux',
    addNew: '+ Nieuw',
    secLocation: "Locatie & afdeling",
    secLocationData: "Locatie-bewuste verzorgingsdata",
    secHealth: "Gezondheid",
    secExpertNotes: "Notities van expert/kwekerij",
    secTemperature: "Temperatuur",
    secCustomCare: "Eigen verzorgingswaarden",
    secQR: "QR-code",
    secDanger: "Gevaarzone",
    secSoil: "Grondmengsel",
    secRepot: "Verpotten",
    secReminders: "Eigen herinneringen",
    secEvents: "Uitzonderlijke verzorging",
    secAI: "AI Plant Advisor",
    secLight: "Lichtmeter",
    secPhotos: "Foto's",
    tplWater: "Water geven",
    tplHealth: "Gezondheidscheck",
    tplEnv: "Omgeving",
    tplGrowth: "Groei",
    tplTreatment: "Behandeling",
    tplMaintenance: "Onderhoud",
    chipPest: "Plagen",
    chipFert: "Bemesting",
    chipGrowth: "Groei",
    chipOther: "Overig",
    ...
    toxicity: "Giftigheid",
    changeSpecies2: "🔄 Soort wijzigen",
    spring: "Lente",
    summer: "Zomer",
    autumn: "Herfst",
    winter: "Winter",
    curSeason: "Huidig seizoen",
    tplFert: "Bemest",
    tplCustom: "Eigen log",
    secHealthShort: "Gezondheid",
    jours: "dagen",
    watToDo: "Wat te doen?",
    m1: "Januari",
    m2: "Februari",
    ...
    m11: "November",
    m12: "December",
    tip1: "Winterrust — bijna geen water voor cactussen & vetplanten. Controleer op plagen die binnenshuis overwinteren.",
    tip2: "Eerste signalen van groei. Begin water voorzichtig te verhogen. Zaai vroeg voor voorjaar.",
    tip3: "Groeiseizoen begint! Herstart bemesting, controleer verpotten. Stek van tropische planten.",
    tip4: "Verpottijd voor de meeste soorten. Verhoog waterfrequentie. Buiten-geschikte planten naar buiten.",
    tip5: "Volle groei — bemest maandelijks. Pas op voor zonverbranding. Controleer op trips.",
    tip6: "Hitte peak — meer water nodig. Bescherm gevoelige planten tegen directe middagzon. Controleer luchtvochtigheid.",
    tip7: "Vakantieperiode — stel auto-waterschema in of wijs verzorger aan.",
    tip8: "Laatste groeisprint. Stop met bemesten eind augustus voor houtachtige soorten.",
    tip9: "Begin waterfrequentie te verlagen. Haal buitenplanten binnen voor nachtvorst.",
    tip10: "Start winterrust cactussen — stop water. Rouwmuggen actief binnenshuis.",
    tip11: "Minimale watergift. Verplaats dichter bij ramen voor licht. Controleer verwarming.",
    tip12: "Rust periode. Alleen water als plant echt droog is. Plan wat te kopen in voorjaar.",
    filterSection:"Afdeling", filterCategory:"Categorie", filterAll:"Alle",
    versionLabel:"Versie",
    calTitle: "Kalender",
    calWater: "Water geven",
    calFertilize: "Bemesten",
    calRepot: "Verpotten",
    calReminder: "Herinnering",
    calNothing: "Geen taken op deze dag",
    calToday: "Vandaag",
    calOverdue: "Te laat",
    calTasksOn: "Taken op",
    calClose: "Sluiten",
  ...
  en: {
    ...
    overview:"Info", seasons:"Seasons", care:"Care", log:"Log",
    quickLog:"Quick log", watered:"Watered", healthCheck:"Health check",
    environment:"Environment", growth:"Growth",
    ...
    yes:"Yes", no:"No",
    noPhoto:"No photo", loadingPhoto:"Loading photo...",
    ...
    addLocation:"+ New location", manageLocations:"Manage locations",
    locations:"Locations", addNewLocation:"+ Add new location",
    locationName:"Location name...", activeLabel:"Active",
    urgentTitle:"Needs water now", overdue:"Overdue", today:"Today",
    settings:"Settings", back:"← Back", save:"Save",
    addPlant:"+ Add plant", searchPlant:"🔍  Search plant or species...",
    waterSchedule:"Water schedule", lastWatered:"Last watered",
    nextWater:"Next watering", health:"Health",
    photos:"Photos", addPhoto:"+ Add photo",
    fertilizer:"Fertilizer", repot:"Repot", pest:"Pest",
    export:"📤 Download backup", import:"📥 Choose backup file",
    importing:"⏳ Importing...",
    deleteAll:"🗑️ Clear all data", deleteConfirm:"Are you sure you want to delete ALL data? This cannot be undone.",
    privacy:"🔒 Privacy", privacyView:"📋 View privacy policy", privacyClose:"▲ Close privacy policy",
    darkMode:"🌙 Display", darkModeOn:"Dark mode active", lightModeOn:"Light mode active",
    lightBtn:"☀️ Light", darkBtn:"🌙 Dark",
    vacation:"🏖️ Vacation mode", vacationDesc:"Pause watering schedules during absence",
    vacationActive:"Active", vacationActivate:"Activate", vacationDeactivate:"Deactivate",
    caretaker:"Caretaker name (optional)", caretakerNotes:"Extra notes for the caretaker...",
    pdfCaretaker:"📄 Generate PDF for caretaker",
    from:"FROM", to:"TO",
    streak:"care streak",
    waterFilter:"Water", pestFilter:"Pests", fertFilter:"Fertilizer", growthFilter:"Growth", allFilter:"All",
    dataTab:"💾 Data export / import",
    scanQR:"📱 QR Scanner", generateQR:"Show QR code",
    lightMeter:"☀️ Light meter", aiAdvisor:"🤖 AI Plant Advisor",
    tabGeneral:"General", tabTaal:"Language", tabSections:"Sections", tabNotif:"Notifications", tabData:"Data",
    waterGiven: '💧 Watered',
    waterToday2: '💧 Water today!',
    waterTmrw: '💧 Water tomorrow',
    waterIn2: '💧 Water in',
    waterEvery: 'Water every',
    waterLog30: '💧 Waterings — last 30 days',
    waterCount: '× watered in 30 days',
    waterOrder: '💧 WATERING SCHEDULE',
    waterNowCare: '💧☀️ Care now',
    snooze: '⏰ Snooze',
    paused: '⚡ Paused',
    pausedDash: ' Paused — ',
    ...
    still: 'still ',
    today2: 'Today',
    healthTitle: '❤️ Health',
    healthPhotos: '❤️ Health + Photos',
    healthy: 'Healthy',
    ideal: 'Ideal',
    moderate: 'Moderate',
    sick: 'Sick',
    ...
    noSeasonNotes: 'No seasonal notes available.',
    noCareData: 'No care data',
    needed: 'Needed!',
    proTips: '💡 Pro Tips',
    expertAdvice: 'Expert advice',
    breederAdvice: 'BREEDER — SPECIFIC ADVICE',
    warning: 'WARNING',
    ...
    changeSpecies: '🔄 Change species (keeps logs + photos)',
    personalNotes: 'Personal notes...',
    customSpecies: 'Custom species',
    careLog: 'Care Log',
    noEntries: 'No entries yet.',
    noCareYet: 'No care data yet.',
    useQuickLog: 'Use Quick Log on the Overview tab.',
    evolution: '📈 Growth over time',
    pestDisease: 'Pest / Disease',
    measureLight: 'Measure how much light reaches ',
    getLocation: '🌍 Get my location',
    luxUnit: ' lux',
    addNew: '+ New',
    secLocation: "Location & section",
    secLocationData: "Location-aware care data",
    secHealth: "Health",
    secExpertNotes: "Expert/nursery notes",
    secTemperature: "Temperature",
    secCustomCare: "Custom care values",
    secQR: "QR code",
    secDanger: "Danger zone",
    secSoil: "Soil mix",
    secRepot: "Repotting",
    secReminders: "Personal reminders",
    secEvents: "Special care events",
    secAI: "AI Plant Advisor",
    secLight: "Light meter",
    secPhotos: "Photos",
    tplWater: "Watering",
    tplHealth: "Health check",
    tplEnv: "Environment",
    tplGrowth: "Growth",
    tplTreatment: "Treatment",
    tplMaintenance: "Maintenance",
    chipPest: "Pests",
    chipFert: "Fertilizer",
    chipGrowth: "Growth",
    chipOther: "Other",
    ...
    toxicity: "Toxicity",
    changeSpecies2: "🔄 Change species",
    spring: "Spring",
    summer: "Summer",
    autumn: "Autumn",
    winter: "Winter",
    curSeason: "Current season",
    tplFert: "Fertilize",
    tplCustom: "Custom log",
    secHealthShort: "Health",
    jours: "days",
    watToDo: "What to do?",
    m1: "January",
    m2: "February",
    ...
    m11: "November",
    m12: "December",
    tip1: "Winter dormancy — almost no water for cacti & succulents. Check for pests overwintering indoors.",
    tip2: "First signs of growth. Start increasing water carefully for cacti. Sow early for spring.",
    tip3: "Growing season starts! Resume fertilizing, check if repotting needed. Take cuttings.",
    tip4: "Repotting time for most species. Increase watering frequency. Move outdoor plants outside gradually.",
    tip5: "Full growth — fertilize monthly. Watch for sunburn when moving outside. Check for thrips.",
    tip6: "Heat peak — more water needed. Protect sensitive plants from direct midday sun. Check humidity.",
    tip7: "Holiday season — set auto-watering or assign a caretaker. Mulch outdoor plants against drying.",
    tip8: "Last growth sprint. Stop fertilizing end of August for woody species. Watch for early herb harvest.",
    tip9: "Start reducing watering. Bring outdoor plants inside before frost. Last repotting of the year.",
    tip10: "Start winter dormancy for cacti — stop watering. Fungus gnats active indoors. Check for mealybugs.",
    tip11: "Minimal watering. Move plants closer to windows for light. Check heating — dry air damages.",
    tip12: "Rest period. Water only if plant is truly dry. Good time to plan spring purchases.",
    filterSection:"Section",  filterCategory:"Category",  filterAll:"All",
    versionLabel:"Version",
    calTitle: "Calendar",
    calWater: "Water",
    calFertilize: "Fertilize",
    calRepot: "Repot",
    calReminder: "Reminder",
    calNothing: "No tasks on this day",
    calToday: "Today",
    calOverdue: "Overdue",
    calTasksOn: "Tasks on",
    calClose: "Close",
  ...
  fr: {
    ...
    overview:"Info", seasons:"Saisons", care:"Soins", log:"Journal",
    ...
    addParameter:"+ Ajouter paramètre", searchParams:"Chercher paramètre...",
    saveLog:"Enregistrer", cancel:"Annuler",
    yes:"Oui", no:"Non",
    noPhoto:"Pas de photo", loadingPhoto:"Chargement...",
    askAdvisor:"Demandez à propos de cette plante...", askBtn:"Demander",
    plantAdvisor:"🤖 Conseiller Plantes",
    locationLabel:"Lieu", sectionLabel:"Section", notesLabel:"Notes",
    addLocation:"+ Nouveau lieu", manageLocations:"Gérer les lieux",
    locations:"Lieux", addNewLocation:"+ Ajouter un lieu",
    locationName:"Nom du lieu...", activeLabel:"Actif",
    urgentTitle:"Arrosage urgent", overdue:"En retard", today:"Aujourd\'hui",
    settings:"Paramètres", back:"← Retour", save:"Enregistrer",
    addPlant:"+ Ajouter plante", searchPlant:"🔍  Rechercher plante...",
    waterSchedule:"Programme d\'arrosage", lastWatered:"Dernier arrosage",
    nextWater:"Prochain arrosage", health:"Santé",
    photos:"Photos", addPhoto:"+ Ajouter photo",
    fertilizer:"Engrais", repot:"Rempoter", pest:"Parasite",
    export:"📤 Télécharger sauvegarde", import:"📥 Choisir fichier",
    importing:"⏳ Importation...",
    deleteAll:"🗑️ Effacer toutes les données", deleteConfirm:"Êtes-vous sûr de vouloir supprimer TOUTES les données? Cette action est irréversible.",
    privacy:"🔒 Confidentialité", privacyView:"📋 Voir la politique", privacyClose:"▲ Fermer",
    darkMode:"🌙 Affichage", darkModeOn:"Mode sombre actif", lightModeOn:"Mode clair actif",
    lightBtn:"☀️ Clair", darkBtn:"🌙 Sombre",
    vacation:"🏖️ Mode vacances", vacationDesc:"Suspendre les programmes pendant l\'absence",
    vacationActive:"Actif", vacationActivate:"Activer", vacationDeactivate:"Désactiver",
    caretaker:"Nom du gardien (optionnel)", caretakerNotes:"Notes supplémentaires...",
    pdfCaretaker:"📄 Générer PDF pour le gardien",
    from:"DU", to:"AU",
    streak:"soins consécutifs",
    waterFilter:"Eau", pestFilter:"Parasites", fertFilter:"Engrais", growthFilter:"Croissance", allFilter:"Tout",
    dataTab:"💾 Export / import données",
    scanQR:"📱 Scanner QR", generateQR:"Afficher le code QR",
    lightMeter:"☀️ Luxmètre", aiAdvisor:"🤖 Conseiller IA",
    tabGeneral:"Général", tabTaal:"Langue", tabSections:"Sections", tabNotif:"Notifications", tabData:"Données",
    waterGiven: '💧 Arrosé',
    waterToday2: '💧 Arroser aujourd\'hui!',
    waterTmrw: '💧 Arroser demain',
    waterIn2: '💧 Arroser dans',
    waterEvery: 'Arroser tous les',
    waterLog30: '💧 Arrosages — 30 derniers jours',
    waterCount: '× arrosé en 30 jours',
    waterOrder: '💧 CALENDRIER D\'ARROSAGE',
    waterNowCare: '💧☀️ Soins maintenant',
    snooze: '⏰ Reporter',
    paused: '⚡ En pause',
    pausedDash: ' En pause — ',
    ...
    today2: 'Aujourd\'hui',
    healthTitle: '❤️ Santé',
    healthPhotos: '❤️ Santé + Photos',
    healthy: 'Sain',
    ideal: 'Idéal',
    moderate: 'Modéré',
    sick: 'Malade',
    points: ' points',
    careNow: '💧☀️ Soins maintenant',
    humidity: 'Humidité',
    ...
    max: 'Max',
    min2: 'Min',
    noSeasonData: 'Pas de données saisonnières',
    noSeasonNotes: 'Pas de notes saisonnières disponibles.',
    noCareData: 'Pas de données de soins',
    needed: 'Nécessaire!',
    proTips: '💡 Conseils Pro',
    expertAdvice: 'Conseils d\'expert',
    breederAdvice: 'PÉPINIÈRE — CONSEILS SPÉCIFIQUES',
    warning: 'ATTENTION',
    locationIcon: '📍 Lieu',
    sectionIcon: '📂 Section',
    notesIcon: '📝 Notes',
    heightIcon: '📏 Hauteur (cm)',
    qrGenerate: '📱 Générer QR code',
    changeSpecies: "🔄 Changer l'espèce (conserve logs + photos)",
    personalNotes: 'Notes personnelles...',
    customSpecies: 'Espèce personnalisée',
    careLog: 'Journal de soins',
    noEntries: 'Pas encore d\'entrées.',
    noCareYet: 'Pas encore de données de soins.',
    useQuickLog: 'Utilisez Journal rapide dans l\'onglet Aperçu.',
    evolution: '📈 Évolution dans le temps',
    pestDisease: 'Ravageur / Maladie',
    measureLight: 'Mesurer la lumière reçue par ',
    getLocation: '🌍 Obtenir ma position',
    luxUnit: ' lux',
    addNew: '+ Nouveau',
    secLocation: "Lieu & section",
    secLocationData: "Données de soins par lieu",
    secHealth: "Santé",
    secExpertNotes: "Notes expert/pépinière",
    secTemperature: "Température",
    secCustomCare: "Soins personnalisés",
    secQR: "Code QR",
    secDanger: "Zone dangereuse",
    secSoil: "Mélange de sol",
    secRepot: "Rempotage",
    secReminders: "Rappels personnels",
    secEvents: "Événements spéciaux",
    secAI: "Conseiller IA",
    secLight: "Luxmètre",
    secPhotos: "Photos",
    tplWater: "Arrosage",
    tplHealth: "Bilan santé",
    tplEnv: "Environnement",
    tplGrowth: "Croissance",
    tplTreatment: "Traitement",
    tplMaintenance: "Entretien",
    chipPest: "Ravageurs",
    chipFert: "Engrais",
    chipGrowth: "Croissance",
    chipOther: "Autre",
    sunMin: "Soleil minimum",
    sunlight: "Lumière",
    soil: "Sol",
    pot: "Pot",
    fertilize: "Engrais",
    ...
    propagation: "Propagation",
    toxicity: "Toxicité",
    changeSpecies2: "🔄 Changer l'espèce",
    spring: "Printemps",
    summer: "Été",
    autumn: "Automne",
    winter: "Hiver",
    curSeason: "Saison actuelle",
    tplFert: "Engrais",
    tplCustom: "Journal perso",
    secHealthShort: "Santé",
    jours: "jours",
    watToDo: "Que faire?",
    m1: "Janvier",
    m2: "Février",
    ...
    m11: "Novembre",
    m12: "Décembre",
    tip1: "Dormance hivernale — presque pas d'eau pour les cactus. Vérifier les parasites hivernants.",
    tip2: "Premiers signes de croissance. Augmenter l'eau progressivement. Semer tôt pour le printemps.",
    tip3: "Saison de croissance! Reprendre la fertilisation, vérifier le rempotage. Boutures.",
    tip4: "Période de rempotage. Augmenter l'arrosage. Sortir les plantes d'extérieur progressivement.",
    tip5: "Pleine croissance — fertiliser mensuellement. Attention aux brûlures solaires. Vérifier les thrips.",
    tip6: "Pic de chaleur — plus d'eau nécessaire. Protéger du soleil de midi. Vérifier l'humidité.",
    tip7: "Période de vacances — configurer l'arrosage auto ou désigner un soignant.",
    tip8: "Dernier sprint de croissance. Arrêter la fertilisation fin août pour les espèces ligneuses.",
    tip9: "Réduire l'arrosage. Rentrer les plantes avant le gel. Dernier rempotage de l'année.",
    tip10: "Début de dormance pour les cactus. Moucherons actifs. Vérifier la cochenille farineuse.",
    tip11: "Arrosage minimal. Rapprocher des fenêtres. Vérifier le chauffage — l'air sec nuit aux plantes.",
    tip12: "Période de repos. Arroser seulement si vraiment sec. Bon moment pour planifier les achats.",
    filterSection:"Section",  filterCategory:"Catégorie", filterAll:"Tout",
    versionLabel:"Version",
    calTitle: "Calendrier",
    calWater: "Arroser",
    calFertilize: "Fertiliser",
    calRepot: "Rempoter",
    calReminder: "Rappel",
    calNothing: "Aucune t\u00e2che ce jour",
    calToday: "Aujourd'hui",
    calOverdue: "En retard",
    calTasksOn: "T\u00e2ches le",
    calClose: "Fermer",
    wd0: "Di",
    wd1: "Lu",
    wd2: "Ma",
  ...
  de: {
    ...
    waterNow:"Gießen nötig", soon:"Bald", avgHealth:"Ø Gesundheit",
    ...
    overview:"Info", seasons:"Jahreszeiten", care:"Pflege", log:"Protokoll",
    quickLog:"Schnellprotokoll", watered:"Gegossen", healthCheck:"Gesundheitscheck",
    ...
    saveLog:"Protokoll speichern", cancel:"Abbrechen",
    yes:"Ja", no:"Nein",
    noPhoto:"Kein Foto", loadingPhoto:"Foto laden...",
    askAdvisor:"Frage zu dieser Pflanze...", askBtn:"Fragen",
    plantAdvisor:"🤖 Pflanzenberater",
    locationLabel:"Standort", sectionLabel:"Bereich", notesLabel:"Notizen",
    addLocation:"+ Neuer Standort", manageLocations:"Standorte verwalten",
    locations:"Standorte", addNewLocation:"+ Neuen Standort hinzufügen",
    locationName:"Standortname...", activeLabel:"Aktiv",
    urgentTitle:"Jetzt gießen", overdue:"Überfällig", today:"Heute",
    settings:"Einstellungen", back:"← Zurück", save:"Speichern",
    addPlant:"+ Pflanze hinzufügen", searchPlant:"🔍  Pflanze oder Art suchen...",
    waterSchedule:"Gießplan", lastWatered:"Zuletzt gegossen",
    nextWater:"Nächste Bewässerung", health:"Gesundheit",
    photos:"Fotos", addPhoto:"+ Foto hinzufügen",
    fertilizer:"Dünger", repot:"Umtopfen", pest:"Schädling",
    export:"📤 Backup herunterladen", import:"📥 Backup-Datei wählen",
    importing:"⏳ Importieren...",
    deleteAll:"🗑️ Alle Daten löschen", deleteConfirm:"Möchten Sie wirklich ALLE Daten löschen? Dies kann nicht rückgängig gemacht werden.",
    privacy:"🔒 Datenschutz", privacyView:"📋 Datenschutzrichtlinie ansehen", privacyClose:"▲ Schließen",
    darkMode:"🌙 Anzeige", darkModeOn:"Dunkelmodus aktiv", lightModeOn:"Hellmodus aktiv",
    lightBtn:"☀️ Hell", darkBtn:"🌙 Dunkel",
    vacation:"🏖️ Urlaubsmodus", vacationDesc:"Gießpläne während der Abwesenheit pausieren",
    vacationActive:"Aktiv", vacationActivate:"Aktivieren", vacationDeactivate:"Deaktivieren",
    caretaker:"Name des Pflegers (optional)", caretakerNotes:"Zusätzliche Hinweise...",
    pdfCaretaker:"📄 PDF für Pfleger erstellen",
    from:"VON", to:"BIS",
    streak:"Pflegestreifen",
    waterFilter:"Gießen", pestFilter:"Schädlinge", fertFilter:"Dünger", growthFilter:"Wachstum", allFilter:"Alle",
    dataTab:"💾 Daten exportieren / importieren",
    scanQR:"📱 QR-Scanner", generateQR:"QR-Code anzeigen",
    lightMeter:"☀️ Lichtmesser", aiAdvisor:"🤖 KI-Pflanzenberater",
    tabGeneral:"Allgemein", tabTaal:"Sprache", tabSections:"Bereiche", tabNotif:"Benachrichtigungen", tabData:"Daten",
    waterGiven: '💧 Gegossen',
    waterToday2: '💧 Heute gießen!',
    waterTmrw: '💧 Morgen gießen',
    waterIn2: '💧 Gießen in',
    waterEvery: 'Gießen alle',
    waterLog30: '💧 Gießvorgänge — letzte 30 Tage',
    waterCount: '× gegossen in 30 Tagen',
    waterOrder: '💧 GIESSZEITPLAN',
    waterNowCare: '💧☀️ Pflege jetzt',
    snooze: '⏰ Verschieben',
    paused: '⚡ Pausiert',
    pausedDash: ' Pausiert — ',
    eventActive: '⚡ Ereignis aktiv',
    dag: 'Tag',
    dagen: 'Tagen',
    still: 'noch ',
    today2: 'Heute',
    healthTitle: '❤️ Gesundheit',
    healthPhotos: '❤️ Gesundheit + Fotos',
    healthy: 'Gesund',
    ideal: 'Ideal',
    moderate: 'Mäßig',
    sick: 'Krank',
    points: ' Punkte',
    careNow: '💧☀️ Pflege jetzt',
    humidity: 'Luftfeuchtigkeit',
    humidityShort: 'Luftfeuchte',
    sun: 'Sonne',
    perDay: 'h/Tag',
    max: 'Max',
    min2: 'Min',
    noSeasonData: 'Keine Saisondaten',
    noSeasonNotes: 'Keine saisonalen Notizen verfügbar.',
    noCareData: 'Keine Pflegedaten',
    needed: 'Erforderlich!',
    proTips: '💡 Profi-Tipps',
    expertAdvice: 'Expertenrat',
    breederAdvice: 'ZÜCHTER — SPEZIFISCHE HINWEISE',
    warning: 'ACHTUNG',
    locationIcon: '📍 Standort',
    sectionIcon: '📂 Bereich',
    notesIcon: '📝 Notizen',
    heightIcon: '📏 Höhe (cm)',
    qrGenerate: '📱 QR-Code generieren',
    changeSpecies: '🔄 Art ändern (behält Logs + Fotos)',
    personalNotes: 'Persönliche Notizen...',
    customSpecies: 'Benutzerdefinierte Art',
    careLog: 'Pflegeprotokoll',
    noEntries: 'Noch keine Einträge.',
    noCareYet: 'Noch keine Pflegedaten.',
    useQuickLog: 'Schnellprotokoll im Übersicht-Tab verwenden.',
    evolution: '📈 Entwicklung über Zeit',
    pestDisease: 'Schädling / Krankheit',
    measureLight: 'Licht messen an ',
    getLocation: '🌍 Meinen Standort ermitteln',
    luxUnit: ' Lux',
    addNew: '+ Neu',
    secLocation: "Standort & Bereich",
    secLocationData: "Standortbezogene Pflegedaten",
    secHealth: "Gesundheit",
    secExpertNotes: "Experten-/Züchternotizen",
    secTemperature: "Temperatur",
    secCustomCare: "Eigene Pflegewerte",
    secQR: "QR-Code",
    secDanger: "Gefahrenzone",
    secSoil: "Erdmischung",
    secRepot: "Umtopfen",
    secReminders: "Eigene Erinnerungen",
    secEvents: "Besondere Pflege",
    secAI: "KI-Pflanzenberater",
    secLight: "Lichtmesser",
    secPhotos: "Fotos",
    tplWater: "Gießen",
    tplHealth: "Gesundheitscheck",
    tplEnv: "Umgebung",
    tplGrowth: "Wachstum",
    tplTreatment: "Behandlung",
    tplMaintenance: "Wartung",
    chipPest: "Schädlinge",
    chipFert: "Dünger",
    chipGrowth: "Wachstum",
    chipOther: "Sonstiges",
    sunMin: "Sonne Minimum",
    ...
    toxicity: "Giftigkeit",
    changeSpecies2: "🔄 Art ändern",
    spring: "Frühling",
    summer: "Sommer",
    autumn: "Herbst",
    winter: "Winter",
    curSeason: "Aktuelle Saison",
    tplFert: "Düngen",
    tplCustom: "Eigenes Protokoll",
    secHealthShort: "Gesundheit",
    jours: "Tage",
    watToDo: "Was tun?",
    m1: "Januar",
    m2: "Februar",
    ...
    m11: "November",
    m12: "Dezember",
    tip1: "Winterruhe — kaum Wasser für Kakteen & Sukkulenten. Auf Schädlinge im Haus achten.",
    tip2: "Erste Wachstumszeichen. Bewässerung für Kakteen vorsichtig erhöhen. Früh säen.",
    tip3: "Wachstumssaison beginnt! Düngung wieder aufnehmen, Umtopfen prüfen. Stecklinge.",
    tip4: "Umtopfzeit für die meisten Arten. Bewässerung erhöhen. Außenpflanzen schrittweise nach draußen.",
    tip5: "Volles Wachstum — monatlich düngen. Sonnenbrand beim Umstellen vermeiden. Auf Thripse achten.",
    tip6: "Hitzehoch — mehr Wasser nötig. Empfindliche Pflanzen vor Mittagssonne schützen. Luftfeuchtigkeit prüfen.",
    tip7: "Urlaubszeit — automatische Bewässerung einrichten oder Pfleger bestimmen.",
    tip8: "Letzter Wachstumsschub. Düngung Ende August für Gehölze stoppen.",
    tip9: "Bewässerung reduzieren. Außenpflanzen vor Frost reinholen. Letztes Umtopfen des Jahres.",
    tip10: "Winterruhe für Kakteen beginnen — kein Wasser mehr. Trauermücken aktiv. Wollläuse prüfen.",
    tip11: "Minimale Bewässerung. Näher ans Fenster stellen. Heizung prüfen — trockene Luft schadet.",
    tip12: "Ruhezeit. Nur gießen wenn wirklich trocken. Gute Zeit um Frühjahrskäufe zu planen.",
    filterSection:"Bereich",  filterCategory:"Kategorie", filterAll:"Alle",
    versionLabel:"Version",
    calTitle: "Kalender",
    calWater: "Gie\u00dfen",
    calFertilize: "D\u00fcngen",
    calRepot: "Umtopfen",
    calReminder: "Erinnerung",
    calNothing: "Keine Aufgaben an diesem Tag",
    calToday: "Heute",
    calOverdue: "\u00dcberf\u00e4llig",
    calTasksOn: "Aufgaben am",
    calClose: "Schlie\u00dfen",
    wd0: "So",
    wd1: "Mo",
    wd2: "Di",
...
const getT = () => T[JSON.parse(localStorage.getItem('plantcare_lang')||'"nl"')] || T.nl;
...
const PARAM_DEFS = {
  ...
  light_hours:         {label:"Light Hours",        icon:"☀️",unit:(getT().perDay||"u/dag"), inputType:"number",min:0,  max:24,   step:0.5,category:"Light",      description:"Hours of light received today"},
  ...
  temperature:         {label:(getT().secTemperature||"Temperatuur"),        icon:"🌡️",unit:"°C",      inputType:"number",min:-10,max:60,   step:0.5,category:"Environment",description:"Ambient temperature near the plant"},
  humidity:            {label:(getT().humidity||"Luchtvochtigheid"),           icon:"💦",unit:"%",       inputType:"number",min:0,  max:100,  step:1,  category:"Environment",description:"Relative air humidity near the plant"},
  ...
  repotting:           {label:(getT().secRepot||"Verpotten"),          icon:"🏺",unit:"",        inputType:"select",category:"Soil",       description:"Repotting event details",options:[{value:"up_one",label:"Potted up one size"},{value:"up_two",label:"Potted up two sizes"},{value:"same_size",label:"Refreshed soil, same pot"},{value:"root_trim",label:"Root-trimmed and returned"}]},
...
const getParamCategories = () => ["Water","Licht",(getT().tplEnv||"Omgeving"),(getT().soil||"Grond"),(getT().tplGrowth||"Groei"),(getT().secHealthShort||"Gezondheid"),(getT().tplMaintenance||"Onderhoud"),"Notities"];

const getQuickTemplates = () => {
  const _t = getT();
  return {
    watering:    {label:(_t.tplWater||"Water geven"),      icon:"💧",color:"#7ABFCC",params:["watering","soil_moisture","drainage_quality"]},
    health_check:{label:(_t.tplHealth||"Gezondheidscheck"), icon:"❤️",color:"#4A7C59",params:["health_score","pest_observation","disease_observation","new_growth","flowering"]},
    environment: {label:(_t.tplEnv||"Omgeving"),  icon:"🌡️",color:"#C9B48A",params:["temperature","humidity","light_hours","light_intensity","air_circulation"]},
    growth:      {label:(_t.tplGrowth||"Groei"),       icon:"📏",color:"#7FB492",params:["height","spread","leaf_count","new_growth"]},
    treatment:   {label:(_t.tplTreatment||"Behandeling"),    icon:"💊",color:"#C1694F",params:["pest_observation","disease_observation","treatment"]},
    maintenance: {label:(_t.tplMaintenance||"Onderhoud"),  icon:"✂️",color:"#7A6A58",params:["pruning","cleaning","misting","repotting","position_change"]},
    fertilizing: {label:(_t.tplFert||"Bemest"),   icon:"🌿",color:"#4A7C59",params:["fertilizing","fertilizer_amount","soil_ph"]},
    custom:      {label:(_t.tplCustom||"Eigen log"),   icon:"📝",color:"#3B2A1A",params:[]},
  };
};
...
const LogModal = ({plant,templateKey,onSave,onClose}) => {
  const t = getT();
  const template=getQuickTemplates()[templateKey];
    ...
    React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.55)",zIndex:200,display:"flex",alignItems:"flex-end"},}
      , React.createElement('div', { style: {background:C.surface,borderRadius:"20px 20px 0 0",width:"100%",maxWidth:600,margin:"0 auto",maxHeight:"90vh",display:"flex",flexDirection:"column"},}
        ...
        , React.createElement('div', { style: {overflowY:"auto",flex:1,padding:"16px 20px"},}
          ...
          , addingParam?(
            React.createElement('div', { style: {border:`1px solid ${C.border}`,borderRadius:10,padding:12,marginBottom:14},}
              ...
              , React.createElement('button', { onClick: ()=>setAddingParam(false), style: {marginTop:8,background:"none",border:"none",color:C.muted,cursor:"pointer",fontSize:12,fontFamily:"inherit"},}, (t.cancel||(t.cancel||(t.cancel||(t.cancel||"Annuleer")))))
            )
          ):(
        ...
        , React.createElement('div', { style: {padding:"12px 20px",borderTop:`1px solid ${C.border}`,display:"flex",gap:10},}
          , React.createElement(Btn, { onClick: onClose, outline: true, color: C.muted, fullWidth: true,}, (t.cancel||(t.cancel||(t.cancel||(t.cancel||"Annuleer")))))
      ...
      , adding ? (
        ...
        React.createElement('button', { onClick: ()=>setAdding(true),
          style: {width:'100%',border:`1px dashed ${C.border}`,borderRadius:10,padding:10,
            ...
            fontSize:13,fontFamily:'inherit'},}, (t.addPhoto||"+ Foto toevoegen")
          ...
          , relevantEvents.map(ev => (
            React.createElement('div', { key: ev.id, style: {marginBottom:10,paddingBottom:10,
              ...
              , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:8},}
                ...
                , React.createElement('span', { style: {fontSize:11,color:C.muted},}, (getT().dagen||"dagen"))
...
const CustomCareEditor = ({plant, onUpdatePlant, season}) => {
  ...
  const fields = [
    {key:`water_${season}`, label:("💧 "+(getT().waterEvery||"Water elke")), unit:"dagen", default: care.water || 7, min:1, max:90,
        ...
        React.createElement('div', { style: {border:`1px solid ${C.border}`,borderRadius:8,padding:10,marginBottom:10},}
          ...
          , React.createElement('button', { onClick: ()=>setAddingParam(false),
            style: {fontSize:11,color:C.muted,background:"none",border:"none",
              cursor:"pointer",fontFamily:"inherit",marginTop:4},}, (t.cancel||(t.cancel||(t.cancel||(t.cancel||"Annuleer")))))
        )
      ) : (
    ...
    React.createElement('div', { style: {background:hasNotes?"#FFFBF0":C.surface,borderRadius:18,padding:16,
      ...
      , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:hasNotes?10:0},}
        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:8},}
          ...
          , React.createElement('div', null
            , React.createElement('div', { style: {fontWeight:700,fontSize:14,color:C.soil},}, (getT().secExpertNotes||"Notities van expert/kwekerij")  )
    ...
    React.createElement('div', { style: {background:C.surface,borderRadius:18,padding:16,marginBottom:12,
      ...
      , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10},}
        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:8},}
          , React.createElement('span', { style: {fontSize:18},}, "⏰")
          , React.createElement('div', null
            , React.createElement('div', { style: {fontWeight:700,fontSize:14,color:C.soil},}, (getT().secReminders||"Eigen herinneringen") )
  ...
  return (
    React.createElement('div', { style: {background:isDue?C.terracottaLight:C.surface,borderRadius:14,padding:16,marginBottom:12,
      ...
      , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6},}
        ...
        , isDue && React.createElement(Badge, { label: (getT().needed||"Nodig!"), color: C.terracotta,})
      )
        ...
        React.createElement('div', { style: {flex:1,display:"flex",flexDirection:"column",alignItems:"center",
          ...
          , measuring && zone && (React.createElement(React.Fragment, null
            , React.createElement('div', { style: {background:zone.bg,borderRadius:12,padding:"12px 20px",
              ...
              , React.createElement('div', { style: {fontSize:36,fontWeight:900,color:"#fff"},}, (avgLux||0).toLocaleString(), (getT().luxUnit||" lux") )
              ...
              , LUX_ZONES.slice(0,-1).map(z => (
                React.createElement('div', { key: z.label, style: {display:"flex",alignItems:"center",gap:10,
                  ...
                  , React.createElement('div', { style: {fontSize:11,color:"rgba(255,255,255,0.4)",flexShrink:0},}
                    , z.max === Infinity ? ">" : "<", z.max === Infinity ? "10k" : z.max.toLocaleString(), (getT().luxUnit||" lux")
                  )
                )
              ))
            )
                ...
                , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:10,marginBottom:4},}
                  ...
                  , React.createElement('div', null
                    ...
                    , React.createElement('div', { style: {fontSize:10,color:"rgba(255,255,255,0.5)"},}
                      , z.max === Infinity ? ">10.000" : "<"+z.max.toLocaleString(), (getT().luxUnit||" lux")
                    )
                  )
                )
      ...
      , React.createElement('div', { style: {background:C.surface,borderRadius:24,width:"100%",maxWidth:380,
        ...
        , step === 0 && (
          React.createElement('button', { onClick: ()=>onDone(),
            style: {width:"100%",marginTop:10,padding:"10px",border:"none",
              background:"none",cursor:"pointer",color:C.muted,fontSize:13,
              fontFamily:"inherit"},}
            , "Overslaan →"
          )
        )
        ...
        , step > 0 && (
          React.createElement('button', { onClick: ()=>setStep(s=>s-1),
            style: {width:"100%",marginTop:10,padding:"10px",border:"none",
              background:"none",cursor:"pointer",color:C.muted,fontFamily:"inherit",fontSize:13},}, (t.back||(t.back||(t.back||"← Terug")))
...
const getMonthlyActions = () => {
  const _t = getT();
  return {
    1:  {label:(_t.m1||"Januari"),   icon:"❄️",  tip:(_t.tip1||"Winterrust — bijna geen water voor cactussen & vetplanten.")},
    2:  {label:(_t.m2||"Februari"),  icon:"❄️",  tip:(_t.tip2||"Eerste signalen van groei. Begin water voorzichtig te verhogen.")},
    3:  {label:(_t.m3||"Maart"),     icon:"🌱",  tip:(_t.tip3||"Groeiseizoen begint! Herstart bemesting.")},
    4:  {label:(_t.m4||"April"),     icon:"🌸",  tip:(_t.tip4||"Verpottijd voor de meeste soorten.")},
    5:  {label:(_t.m5||"Mei"),       icon:"☀️",  tip:(_t.tip5||"Volle groei — bemest maandelijks.")},
    6:  {label:(_t.m6||"Juni"),      icon:"☀️",  tip:(_t.tip6||"Hitte peak — meer water nodig.")},
    7:  {label:(_t.m7||"Juli"),      icon:"🌊",  tip:(_t.tip7||"Vakantieperiode — stel auto-waterschema in.")},
    8:  {label:(_t.m8||"Augustus"),  icon:"🍂",  tip:(_t.tip8||"Laatste groeisprint.")},
    9:  {label:(_t.m9||"September"), icon:"🍁",  tip:(_t.tip9||"Begin waterfrequentie te verlagen.")},
    10: {label:(_t.m10||"Oktober"),  icon:"🍂",  tip:(_t.tip10||"Start winterrust cactussen.")},
    11: {label:(_t.m11||"November"), icon:"❄️",  tip:(_t.tip11||"Minimale watergift.")},
    12: {label:(_t.m12||"December"), icon:"❄️",  tip:(_t.tip12||"Rust periode.")},
  };
};

const CalendarScreen = ({plants, sections, onClose, onSelectPlant}) => {
  const t = getT();
  const now = new Date();
  ...
  const taskMap = useMemo(() => {
    const map = {};
    const push = (iso, task) => { (map[iso] = map[iso] || []).push(task); };
    plants.forEach(plant => {
      if (plant.nextWater && !plant.snoozedUntil) {
        push(plant.nextWater.split("T")[0], {type:"water", plant, label:(t.calWater||"Water geven")});
      }
      (plant.customReminders || []).forEach(r => {
        if (r.done) return;
        push(r.datetime.split("T")[0], {type:"reminder", plant, label:(r.text||t.calReminder||"Herinnering")});
      });
      if (plant.nextRepot) push(plant.nextRepot.split("T")[0], {type:"repot", plant, label:(t.calRepot||"Verpotten")});
      if (plant.nextFertilize) push(plant.nextFertilize.split("T")[0], {type:"fertilize", plant, label:(t.calFertilize||"Bemesten")});
    });
    return map;
  }, [plants]);

  const typeIcon = {water:"💧", fertilize:"🌿", repot:"🪴", reminder:"🔔"};
  const typeColor = {water:"#7ABFCC", fertilize:"#4A7C59", repot:"#C1694F", reminder:"#C9A227"};
  const monthNames = [t.m1,t.m2,t.m3,t.m4,t.m5,t.m6,t.m7,t.m8,t.m9,t.m10,t.m11,t.m12];
  const weekdays = [t.wd1,t.wd2,t.wd3,t.wd4,t.wd5,t.wd6,t.wd0];
  ...
  return (
    React.createElement('div', { style: {position:"fixed",inset:0,background:C.bg,zIndex:200,fontFamily:"system-ui,sans-serif",overflowY:"auto",WebkitOverflowScrolling:"touch"},}
      , React.createElement('div', { style: {background:`linear-gradient(160deg, ${C.soil} 0%, ${C.soilLight} 100%)`,padding:"44px 20px 16px",position:"relative",overflow:"hidden"},}
        , React.createElement('div', { style: {position:"absolute",right:-10,top:-10,fontSize:80,opacity:0.06,pointerEvents:"none"},}, "📅")
        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:12,marginBottom:14},}
          , React.createElement('button', { onClick: onClose, className:"pca-btn", style: {background:"rgba(255,255,255,0.12)",border:"1px solid rgba(255,255,255,0.15)",color:C.sand,cursor:"pointer",fontSize:13,padding:"6px 12px",borderRadius:10,fontFamily:"inherit",fontWeight:600},}, (t.back||"← Terug"))
          , React.createElement('div', { style: {fontSize:22,fontWeight:900,color:"#F5F1EB"},}, (t.calTitle||"Kalender"))
        )
        , React.createElement('div', { style: {display:"flex",alignItems:"center",justifyContent:"space-between"},}
          , React.createElement('button', { onClick: prevMonth, style: {background:"rgba(255,255,255,0.15)",border:"none",color:"#fff",borderRadius:10,width:36,height:36,cursor:"pointer",fontSize:18,fontWeight:700},}, "‹")
          , React.createElement('div', { style: {fontSize:17,fontWeight:800,color:"#fff"},}, (monthNames[viewMonth]||"")+" "+viewYear)
          , React.createElement('button', { onClick: nextMonth, style: {background:"rgba(255,255,255,0.15)",border:"none",color:"#fff",borderRadius:10,width:36,height:36,cursor:"pointer",fontSize:18,fontWeight:700},}, "›")
        )
      )
      , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"repeat(7,1fr)",gap:4,padding:"12px 12px 4px"},}
        , weekdays.map((wd,i) => React.createElement('div', { key:i, style: {textAlign:"center",fontSize:11,fontWeight:700,color:C.muted,padding:"4px 0"},}, wd))
      )
      , React.createElement('div', { style: {display:"grid",gridTemplateColumns:"repeat(7,1fr)",gap:4,padding:"0 12px 12px"},}
        , cells.map((d, idx) => {
            if (d === null) return React.createElement('div', { key:"e"+idx });
            const iso = isoFor(d);
            const tasks = taskMap[iso] || [];
            const isToday = iso === todayISO;
            const isOverdue = tasks.length > 0 && iso < todayISO;
            const types = [...new Set(tasks.map(x=>x.type))];
            return React.createElement('button', { key:iso, onClick:()=>setSelectedDay(iso),
                style: {aspectRatio:"1",border:isToday?`2px solid ${C.green}`:`1px solid ${C.border}`,borderRadius:10,background:isOverdue?"#F8D7D7":(tasks.length?C.surfaceAlt:C.surface),cursor:"pointer",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"flex-start",padding:"4px 2px",position:"relative",fontFamily:"inherit"},}
              , React.createElement('div', { style: {fontSize:13,fontWeight:isToday?800:600,color:isOverdue?C.danger:(isToday?C.green:C.text)},}, d)
              , tasks.length>0 && React.createElement('div', { style: {display:"flex",gap:1,marginTop:2,flexWrap:"wrap",justifyContent:"center"},}
                  , types.slice(0,3).map((tp,i)=>React.createElement('span', { key:i, style: {fontSize:8,lineHeight:1},}, typeIcon[tp])))
              , isOverdue && React.createElement('div', { style: {position:"absolute",top:2,right:2,width:6,height:6,borderRadius:"50%",background:C.danger},})
            );
          })
      )
      , React.createElement('div', { style: {display:"flex",gap:12,flexWrap:"wrap",justifyContent:"center",padding:"4px 16px 20px",fontSize:11,color:C.muted},}
        , [["water",t.calWater],["fertilize",t.calFertilize],["repot",t.calRepot],["reminder",t.calReminder]].map(([tp,lbl])=>
            React.createElement('div', { key:tp, style: {display:"flex",alignItems:"center",gap:3},}
              , React.createElement('span', { style: {fontSize:12},}, typeIcon[tp])
              , React.createElement('span', null, lbl)))
      )
      , selectedDay && React.createElement('div', { onClick:()=>setSelectedDay(null), style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.5)",zIndex:300,display:"flex",alignItems:"flex-end",justifyContent:"center"},}
        , React.createElement('div', { onClick:(e)=>e.stopPropagation(), style: {background:C.bg,borderRadius:"20px 20px 0 0",width:"100%",maxWidth:600,maxHeight:"70vh",overflowY:"auto",padding:"20px",boxShadow:"0 -4px 20px rgba(0,0,0,0.2)"},}
          , React.createElement('div', { style: {width:40,height:4,background:C.border,borderRadius:2,margin:"0 auto 16px"},})
          , React.createElement('div', { style: {fontSize:17,fontWeight:800,color:C.soil,marginBottom:4},}, (t.calTasksOn||"Taken op")+" "+new Date(selectedDay+"T00:00:00").getDate()+" "+(monthNames[new Date(selectedDay+"T00:00:00").getMonth()]||""))
          , selectedDay < todayISO && selectedTasks.length>0 && React.createElement('div', { style: {fontSize:12,color:C.danger,fontWeight:700,marginBottom:12},}, "⚠️ "+(t.calOverdue||"Te laat"))
          , selectedTasks.length === 0
            ? React.createElement('div', { style: {padding:"24px 0",textAlign:"center",color:C.muted,fontSize:14},}, (t.calNothing||"Geen taken op deze dag"))
            : React.createElement('div', { style: {marginTop:12,display:"flex",flexDirection:"column",gap:8},}
                , selectedTasks.map((task,i)=>React.createElement('button', { key:i, onClick:()=>{onSelectPlant(task.plant.id);onClose();},
                    style: {display:"flex",alignItems:"center",gap:12,padding:"12px 14px",background:C.surface,border:`1px solid ${C.border}`,borderLeft:`4px solid ${typeColor[task.type]}`,borderRadius:12,cursor:"pointer",textAlign:"left",fontFamily:"inherit",width:"100%"},}
                  , React.createElement('span', { style: {fontSize:22},}, typeIcon[task.type])
                  , React.createElement('div', { style: {flex:1},}
                    , React.createElement('div', { style: {fontWeight:700,fontSize:14,color:C.text},}, task.plant.name)
                    , React.createElement('div', { style: {fontSize:12,color:C.muted,marginTop:1},}, task.label))
                  , React.createElement('span', { style: {fontSize:16,color:C.muted},}, "›")
                )))
          , React.createElement('button', { onClick:()=>setSelectedDay(null), style: {width:"100%",marginTop:16,padding:"12px",border:"none",borderRadius:12,background:C.surfaceAlt,color:C.text,cursor:"pointer",fontFamily:"inherit",fontWeight:600,fontSize:14},}, (t.calClose||"Sluiten"))
        )
      )
    )
  );
...
const SeasonalCalendar = ({plants}) => {
  ...
  const monthData = getMonthlyActions()[month];
  ...
  return (
    React.createElement('div', { style: {background:C.surface,borderRadius:18,marginBottom:12,overflow:"hidden",
      ...
      , React.createElement('div', { style: {background:`linear-gradient(135deg, ${C.soilLight}, ${C.soil})`,
        ...
        , React.createElement('div', { style: {flex:1},}
          , React.createElement('div', { style: {fontWeight:800,fontSize:15,color:"#F5F1EB"},}
            , monthData.label, " — "+(getT().watToDo||"Wat te doen?")
          )
      ...
      , React.createElement('div', { style: {padding:"10px 16px",display:"flex",gap:4,overflowX:"auto"},}
        , Object.entries(getMonthlyActions()).map(([m, md])=>(
...
// Loaded lazily the first time a QR code is needed
let _qrLibLoaded = false;
const _ensureQRLib = () => new Promise((resolve) => {
...
const generateQRDataURL = (text, size=200) => {
  // Synchronous fallback canvas QR using pure-JS encoding (no external lib needed)
  // This is a real, scannable QR code using the qrcode-generator algorithm
  // encoded inline so it works offline too.
  try {
    // Use the global qrcode if available (loaded by QRCodeDisplay)
    if (window.qrcode) {
      ...
      const canvas = document.createElement("canvas");
      const padding = 4;
      const cellSize = Math.floor((size - padding*2) / modules);
      const actualSize = modules * cellSize + padding * 2;
  ...
  // Library not yet loaded — return blank white square, will re-render once loaded
  const canvas = document.createElement("canvas");
  ...
  ctx.fillText("QR laden...", size/2, size/2);
  return canvas.toDataURL("image/png");
};
...
const QRCodeDisplay = ({plant, onClose}) => {
  ...
  // Load qrcode-generator library then re-render
  useEffect(() => {
  ...
  const qrData = qrReady ? generateQRDataURL(plantUrl, 220) : null;
    ...
    React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.7)",zIndex:400,
      ...
      , React.createElement('div', { style: {background:C.surface,borderRadius:24,padding:24,width:"100%",maxWidth:360,
        ...
        , React.createElement('div', { id: `qr-card-${plant.id}`, style: {background:"#fff",borderRadius:16,padding:16,
          ...
          , qrData ? React.createElement('img', { src: qrData, alt: "QR code" , style: {width:160,height:160,display:"block",margin:"0 auto 10px"},}) : React.createElement('div', {style:{width:160,height:160,display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto 10px",background:"#f5f5f5",borderRadius:8,color:"#999",fontSize:13}}, "QR laden...")
    ...
    if (video.readyState === video.HAVE_ENOUGH_DATA) {
      ...
      if (jsQR) {
        ...
        if (code) {
          ...
          // Match plant ID from plantcare://plant/ID or bare ID
          const idMatch = text.match(/plantcare:\/\/plant\/([a-z0-9_-]+)/i)
                       || text.match(/^([a-z0-9_-]{6,})$/i);
          const plantId = idMatch ? idMatch[1] : text;
          const plant = plants.find(p => p.id === plantId || p.id === plantId.toLowerCase());
          if (plant) {
            stopCamera();
            setDetected(plant);
            ...
            // QR found but no matching plant — flash message and keep scanning
            setDetected({notFound: true, scanned: text.slice(0,60)});
            setTimeout(() => setDetected(null), 2000);
          }
        }
      }
    }
      ...
      , React.createElement('div', { style: {background:C.surface,borderRadius:"20px 20px 0 0",width:"100%",
        ...
        , React.createElement('div', { style: {padding:"12px 20px 8px"},}
          , React.createElement('input', { value: query, onChange: e=>setQuery(e.target.value), autoFocus: true,
            placeholder: (t.searchPlant||"Zoek soort...") ,
            style: {width:"100%",border:`1.5px solid ${C.green}`,borderRadius:10,
              padding:"10px 12px",fontSize:14,outline:"none",fontFamily:"inherit",
              boxSizing:"border-box"},})
        )
        ...
        , React.createElement('div', { style: {overflowY:"auto",flex:1,padding:"14px 20px 20px"},}
          ...
          , pest && (
            React.createElement('div', { style: {marginBottom:14},}
              ...
              , React.createElement('div', { style: {display:"flex",gap:8},}
                , [{id:"mild",label:"Licht",color:C.green},{id:"medium",label:(getT().moderate||"Matig"),color:C.warning},{id:"severe",label:"Ernstig",color:C.danger}].map(s=>(
...
const PlantDetail = ({plant,logs,sections,onAddSection,onBack,onUpdatePlant,onAddLog,onDeleteLog,onUpdateLog,onDelete,t,apiKey}) => {
  ...
  const handleWatered=()=>{
    ...
    onAddLog({id:uid(),plantId:plant.id,timestamp:new Date().toISOString(),parameters:{watering:200},notes:(getT().waterGiven||"💧 Water gegeven")});
  };
  ...
  return(
    React.createElement('div', { style: {position:"fixed",inset:0,background:C.bg,zIndex:200,fontFamily:"system-ui,sans-serif",overflowY:"auto",WebkitOverflowScrolling:"touch"},}
      ...
      , React.createElement('div', { style: {position:"relative",height:220,background:C.soil,overflow:"hidden"},}
        ...
        , photoLoading && React.createElement('div', { style: {position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:8},}, React.createElement('div', { style: {fontSize:60,opacity:0.4},}, emoji), React.createElement('div', { style: {color:"rgba(255,255,255,0.6)",fontSize:12},}, (t.loadingPhoto||"Foto laden...") ))
        ...
        , React.createElement('button', { onClick: onBack, className: "pca-btn", style: {position:"absolute",top:48,left:20,
          ...
          display:"flex",alignItems:"center",gap:5},}, (t.back||(t.back||(t.back||"← Terug")))
          ...
          , React.createElement('div', { style: {display:"flex",alignItems:"flex-end",gap:12},}
            ...
            , React.createElement('div', { style: {flex:1},}
              ...
              , React.createElement('div', { style: {display:"flex",gap:6,marginTop:4,flexWrap:"wrap"},}
                ...
                , !sp&&React.createElement(Badge, { label: (getT().customSpecies||"Eigen soort") , color: C.sky,})
              )
            )
          )
        )
      ...
      , waterPaused ? (
        React.createElement('div', { style: {background:C.warning,padding:"10px 20px",display:"flex",justifyContent:"space-between",alignItems:"center"},}
          , React.createElement('span', { style: {color:"#fff",fontWeight:700,fontSize:14},}, "⚡ "
             , _optionalChain([pausedEvt, 'optionalAccess', _168 => _168.icon]), (getT().pausedDash||" Gepauzeerd — ")   , _optionalChain([pausedEvt, 'optionalAccess', _169 => _169.label])
          )
          , React.createElement('span', { style: {color:"rgba(255,255,255,0.8)",fontSize:12},}, (getT().still||"nog ")
             , Math.ceil((new Date(_optionalChain([pausedEvt, 'optionalAccess', _170 => _170.endDate]))-new Date())/86400000), (getT().dagen?" "+getT().dagen:" dagen")
          )
        )
      ) : days!==null&&(
        React.createElement('div', { style: {background:urgColor(days),padding:"10px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",gap:8},}
          , React.createElement('span', { style: {color:"#fff",fontWeight:700,fontSize:13,flex:1},}
            , days<=0?(_optionalChain([t, 'optionalAccess', _171 => _171.waterToday])||(t.waterToday||(getT().waterToday2||"💧 Water vandaag!"))):days===1?(_optionalChain([t, 'optionalAccess', _172 => _172.waterTomorrow])||(getT().waterTmrw||"💧 Water morgen")):`${_optionalChain([t, 'optionalAccess', _173 => _173.waterIn])||(getT().waterIn2||"💧 Water over")} ${days} ${days===1?(_optionalChain([t, 'optionalAccess', _174 => _174.day])||(getT().dag||"dag")):(_optionalChain([t, 'optionalAccess', _175 => _175.days])||"dagen")}`
          )
          , React.createElement('button', { onClick: ()=>setShowSnooze(true),
            style: {background:"rgba(255,255,255,0.2)",color:"#fff",border:"1px solid rgba(255,255,255,0.3)",
              borderRadius:16,padding:"5px 10px",cursor:"pointer",fontSize:11,fontFamily:"inherit",fontWeight:600,flexShrink:0},}, (getT().snooze||"⏰ Uitstellen")
          ...
          , React.createElement('button', { onClick: handleWatered,
            ...
            , _optionalChain([t, 'optionalAccess', _176 => _176.markWatered])||(getT().waterGiven||"✓ Water gegeven")
          )
        )
      )
      ...
      , React.createElement('div', { style: {display:"flex",borderBottom:`2px solid ${C.border}`,background:C.surface},}
        , [
          ...
          {id:"seasons",  label:_optionalChain([t, 'optionalAccess', _178 => _178.seasons])||(t.seasons||"Seizoenen"),   icon:"🗓"},
          {id:"care",     label:_optionalChain([t, 'optionalAccess', _179 => _179.care])||(t.care||"Verzorging"),     icon:"🌿"},
          {id:"log",      label:`${_optionalChain([t, 'optionalAccess', _180 => _180.log])||"Log"} (${plantLogs.length})`, icon:"📝"},
          {id:"meer",     label:(getT().tabMeer||"Meer"), icon:"⋯"},
        ].map(tb=>(
      ...
      , React.createElement('div', { style: {padding:16,maxWidth:600,margin:"0 auto",paddingBottom:40},}
        ...
        , (tab==="overview"||tab==="care"||tab==="meer")&&(
          React.createElement(React.Fragment, null
            /* ── Expert notes — open by default when notes exist ── */
            , (tab==="meer") && React.createElement(CollapsibleCard, {
              icon: "📋", title: (getT().secExpertNotes||"Notities van expert/kwekerij")  ,
              defaultOpen: !!(plant.expertNotes&&plant.expertNotes.trim()),
              badge: _optionalChain([plant, 'access', _181 => _181.expertNotes, 'optionalAccess', _182 => _182.trim, 'call', _183 => _183()])?(getT().expertAdvice||"Expert advies"):null,
              urgent: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            , (tab==="overview") && 
        React.createElement("div", {style:{display:"flex",alignItems:"center",gap:8,padding:"14px 4px 4px",marginTop:4}}, React.createElement("div", {style:{width:3,height:14,background:"#3D6B4A",borderRadius:2}}), React.createElement("span", {style:{fontSize:10,fontWeight:800,color:"#3D6B4A",letterSpacing:1,textTransform:"uppercase"}}, (getT().waterNowCare||"💧☀️ Verzorging nu"))),
        
        (tab==="overview") && React.createElement("div", {style:{display:"flex",alignItems:"center",gap:8,padding:"14px 4px 4px",marginTop:4}}, React.createElement("div", {style:{width:3,height:14,background:"#6D5D4C",borderRadius:2}}), React.createElement("span", {style:{fontSize:10,fontWeight:800,color:"#6D5D4C",letterSpacing:1,textTransform:"uppercase"}}, (getT().healthPhotos||"❤️ Gezondheid + Fotos"))),
        (tab==="overview") && React.createElement(CollapsibleCard, {
              icon: SEASON_ICONS[season],
              title: `${season.charAt(0).toUpperCase()+season.slice(1)} — ${getT().curSeason||"Huidig seizoen"}`,
              defaultOpen: true,
              badge: care.hasActiveEvents?(getT().eventActive||"⚡ Event actief"):null,
              ...
              , sp ? (
                React.createElement('div', { style: {paddingTop:12},}
                  ...
                  , React.createElement('div', { style: {marginBottom:10},}
                    , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",marginBottom:4,fontSize:12},}
                      , React.createElement('span', { style: {color:C.muted},}, ("💧 "+(getT().waterEvery||"Water elke"))  )
                      , care.waterMultiplier === 0 ? (
                        React.createElement('span', { style: {fontWeight:700,color:C.warning,display:"flex",alignItems:"center",gap:4},}, (getT().paused||"⚡ Gepauzeerd") )
                      ) : care.waterMultiplier < 1 ? (
                        React.createElement('span', { style: {fontWeight:700,color:C.warning},}, care.water, (getT().dagen?" "+getT().dagen+" ":" dagen ")  , React.createElement('span', { style: {fontWeight:400,fontSize:11},}, "(×", care.waterMultiplier, ")"))
                      ) : (
                        React.createElement('span', { style: {fontWeight:700,color:C.sky},}, care.water, (getT().dagen?" "+getT().dagen:" dagen") )
                      )
                    )
                  ...
                  , [
                    {label:(getT().humidity||"Luchtvochtigheid"),value:care.humidity,max:100,unit:"%",icon:"💦",color:C.sky},
                    {label:(getT().sunMin||"Zon minimaal"),value:sunlight.min,max:12,unit:" uur/dag",icon:"☀️",color:C.warning},
                    {label:(getT().secHealthShort||"Gezondheid"),value:plant.health,max:100,unit:"%",icon:"❤️",color:plant.health>70?C.green:plant.health>40?C.warning:C.danger},
                  ...
                  , _optionalChain([care, 'access', _184 => _184.expertBullets, 'optionalAccess', _185 => _185.length]) > 0 && (
                    React.createElement('div', { style: {marginTop:10,background:"#FFFBF0",
                      ...
                      , React.createElement('div', { style: {background:C.sand+"22",padding:"8px 12px",
                        ...
                        , React.createElement('span', { style: {fontWeight:700,fontSize:11,color:C.sand,letterSpacing:0.5},}, (getT().breederAdvice||"KWEKERIJ — SPECIFIEK ADVIES")

                        )
                        , React.createElement('span', { style: {marginLeft:"auto",fontSize:10,color:C.muted,fontWeight:500},}
                          , care.expertBullets.length, (getT().points||" punten")
                        )
                      )
                        ...
                        return (React.createElement(React.Fragment, null
                          , hasTimeline && (
                            React.createElement('div', { style: {padding:"8px 12px 4px",borderBottom:`1px solid ${C.sand}22`},}
                              , React.createElement('div', { style: {fontSize:10,fontWeight:700,color:C.muted,letterSpacing:0.5,marginBottom:6},}, (getT().waterOrder||"💧 WATERSCHEMA VOLGORDE")
                                  ...
                                  , React.createElement('div', { style: {flex:1,paddingTop:2},}
                                    ...
                                    , b.urgent&&(
                                      React.createElement('span', { style: {display:"inline-block",marginTop:3,fontSize:10,
                                        ...
                                        background:C.terracottaLight,borderRadius:4,padding:"1px 6px"},}, ("⚠️ "+(getT().warning||"LET OP"))
                          ...
                          , !hasTimeline && waterBullets.map((b,i)=>(
                            React.createElement('div', { key: i, style: {display:"flex",alignItems:"flex-start",gap:8,
                              ...
                              , b.urgent&&React.createElement('span', { style: {fontSize:10,fontWeight:700,color:C.danger,
                                background:C.terracottaLight,borderRadius:4,padding:"1px 6px",flexShrink:0},}, (getT().warning||"LET OP")
                                 )
                            )
                          ))
                ...
                React.createElement('div', { style: {paddingTop:12,textAlign:"center"},}
                  ...
                  , React.createElement('div', { style: {fontSize:13,color:C.muted,lineHeight:1.5},}, (getT().noCareYet||"Nog geen verzorgingsdata."), " ", React.createElement('strong', null, (getT().getLocation||"🌍 Ophalen op mijn locatie")), " hieronder."
                  )
                )
              )
            )
            ...
            /* ── Quick log ── */
            , (tab==="overview") && React.createElement(CollapsibleCard, { icon: "📝", title: (t.quickLog||(t.quickLog||"Snel loggen")) , defaultOpen: true,}
              , React.createElement('div', { style: {paddingTop:12,display:"grid",gridTemplateColumns:"1fr 1fr",gap:8},}
                , Object.entries(getQuickTemplates()).map(([key,tpl])=>(
                ...
                , React.createElement('button', { onClick: ()=>setShowFertLog(true),
                  ...
                  , React.createElement('div', { style: {fontWeight:700,fontSize:12,color:"#3D6B4A"},}, (getT().chipFert||"Bemesting"))
                )
                , React.createElement('button', { onClick: ()=>setShowPestLog(true),
                  style: {background:C.danger+"18",border:`1px solid ${C.danger}44`,
                    borderRadius:10,padding:"10px 12px",cursor:"pointer",textAlign:"left",fontFamily:"inherit"},}
                  , React.createElement('div', { style: {fontSize:16,marginBottom:2},}, "🦠")
                  , React.createElement('div', { style: {fontWeight:700,fontSize:12,color:C.danger},}, (getT().pestDisease||"Plaag / Ziekte")  )
                )
              )
            )

            /* ── Temperature ── */
            , (tab==="overview") && React.createElement(CollapsibleCard, { icon: "🌡️", title: (getT().secTemperature||"Temperatuur"), defaultOpen: false,}
              , sp ? (
                React.createElement('div', { style: {paddingTop:12,display:"flex",gap:8},}
                  , [{label:(getT().min2||"Min"),val:`${sp.temp.min}°C`,color:C.sky,bg:C.surfaceAlt},
                    {label:(getT().ideal||"Ideaal"),val:sp.temp.ideal,color:C.green,bg:C.greenPale},
                    {label:(getT().max||"Max"),val:`${sp.temp.max}°C`,color:C.terracotta,bg:C.terracottaLight}
            ...
            , (tab==="overview") && React.createElement(CollapsibleCard, { icon: "📍", title: (getT().secLocation||"Locatie & afdeling")  , defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
                , React.createElement('div', { style: {fontWeight:600,color:C.soil,marginBottom:6,fontSize:13},}, ("📍 "+(t.locationLabel||"Locatie")) )
                ...
                , React.createElement('div', { style: {fontWeight:600,color:C.soil,marginBottom:8,fontSize:13},}, ("📂 "+(t.sectionLabel||"Afdeling")) )
                ...
                , React.createElement('div', { style: {fontWeight:600,color:C.soil,marginBottom:6,marginTop:14,fontSize:13},}, ("📝 "+(t.notes||"Notities")) )
                , React.createElement('textarea', { value: plant.notes, onChange: e=>onUpdatePlant({...plant,notes:e.target.value}),
                  rows: 3, placeholder: (getT().personalNotes||"Persoonlijke notities...") ,
                  style: {width:"100%",border:`1px solid ${C.border}`,borderRadius:8,padding:"8px 10px",
            ...
            /* ── Health ── */
            , React.createElement(CollapsibleCard, { icon: "❤️", title:(getT().secHealth||(getT().secHealthShort||"Gezondheid")),
              ...
              , React.createElement('div', { style: {paddingTop:12},}
                ...
                , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",fontSize:10,color:C.muted,marginBottom:8},}
                  , React.createElement('span', null, (getT().sick||"Ziek")), React.createElement('span', null, (getT().moderate||"Matig")), React.createElement('span', null, (getT().healthy||"Gezond"))
                )
            ...
            /* ── Care events ── */
            , (tab==="care") && React.createElement(CollapsibleCard, { icon: "⚡", title: (getT().secEvents||"Uitzonderlijke verzorging") ,
            ...
            /* ── Custom reminders ── */
            , (tab==="care") && React.createElement(CollapsibleCard, { icon: "⏰", title: (getT().secReminders||"Eigen herinneringen") ,
            ...
            /* ── Repotting ── */
            , (tab==="care") && React.createElement(CollapsibleCard, { icon: "🏺", title: (getT().secRepot||"Verpotten"),
              ...
              badge: (() => { const lr=plant.lastRepotted||plant.addedDate; const m=Math.floor((Date.now()-new Date(lr))/(1000*60*60*24*30.5)); const due=plant.repotIntervalMonths||24; return m>=due?(getT().needed||"Nodig!"):null; })(),
              defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            /* ── Licht meter ── */
            , (tab==="care") && React.createElement(CollapsibleCard, { icon: "☀️", title: (getT().secLight||"Lichtmeter"),
              defaultOpen: false,
                        ...
                        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:10,
                          ...
                          , React.createElement('div', null
                            ...
                            , React.createElement('div', { style: {fontSize:12,color:C.muted},}, "Gemeten: "
                               , React.createElement('strong', null, plant.lastLuxReading.toLocaleString(), (getT().luxUnit||" lux") )
            ...
            , (tab==="care") && React.createElement(CollapsibleCard, { icon: "🌍", title: (getT().secLocationData||"Locatie-bewuste verzorgingsdata") , defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            /* ── AI advisor ── */
            , (tab==="meer") && React.createElement(CollapsibleCard, { icon: "🤖", title: "AI Plant Advisor"  ,
              defaultOpen: false,
            ...
            /* ── Photos ── */
            , (tab==="overview") && React.createElement(CollapsibleCard, { icon: "📷", title:`${getT().secPhotos||"Foto's"} (${(plant.photos||[]).length})`,
            ...
            /* ── Soil mix ── */
            , (tab==="care") && React.createElement(CollapsibleCard, { icon: "🏺", title: (getT().secSoil||"Grondmengsel"),
            ...
            /* ── Custom care values ── */
            , (tab==="care") && React.createElement(CollapsibleCard, { icon: "⚙️", title: (getT().secCustomCare||"Eigen verzorgingswaarden") , defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            /* ── Danger zone ── */
            /* ── QR code ── */
            , (tab==="meer") && React.createElement(CollapsibleCard, { icon: "📱", title: (getT().secQR||"QR-code"), defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
                ...
                , React.createElement(Btn, { onClick: ()=>setShowQR(true), fullWidth: true,}, (getT().qrGenerate||"📱 QR-code genereren")  )
              )
            )

            , onDelete && tab==="meer" && (
              React.createElement(CollapsibleCard, { icon: "🗑️", title: (getT().secDanger||"Gevaarzone"), defaultOpen: false,}
                , React.createElement('div', { style: {paddingTop:12},}
        ...
        , tab==="seasons"&&(React.createElement(React.Fragment, null
          , !sp && (
            React.createElement('div', { style: {textAlign:"center",padding:40,color:C.muted},}
              ...
              , React.createElement('div', { style: {fontWeight:700,color:C.soil,marginBottom:8},}, (getT().noSeasonData||"Geen seizoensdata") )
              , React.createElement('div', { style: {fontSize:13,lineHeight:1.5},}, "Tik op "  , React.createElement('strong', null, (getT().getLocation||"🌍 Ophalen op mijn locatie")    ), " op het Overzicht tabblad om verzorgingsdata op te halen."         )
            )
          )
              ...
              React.createElement('div', { key: s, style: {background:isCurrent?C.greenPale:C.surface,
                ...
                , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10},}
                  ...
                  , React.createElement('div', { style: {display:"flex",gap:6,alignItems:"center"},}
                    , hasEvent && React.createElement(Badge, { label: (getT().eventActive||"⚡ Event actief")  , color: C.warning,})
                    , isCurrent && React.createElement(Badge, { label: "Nu", color: C.green,})
                  )
                )
                , React.createElement('div', { style: {display:"flex",gap:8,marginBottom:10},}
                  , [
                    {label:(getT().waterEvery||"Water elke"), val:baseWater, unit:"dagen", color:customWater?C.green:C.sky,
                     overridden:!!customWater},
                    {label:(getT().humidityShort||"Luchtvocht."), val:baseHum,   unit:"%",     color:customHum?C.green:C.sky,
                     overridden:!!customHum},
                    {label:(getT().sun||"Zon"),        val:`${sunlight.min}–${sunlight.max}`, unit:(getT().perDay||"u/dag"),
                ...
                , React.createElement('div', { style: {background:isCurrent?"rgba(255,255,255,0.6)":C.sandLight,borderRadius:8,
                  ...
                  , spCare.notes || (getT().noSeasonNotes||"Geen seizoensnotities beschikbaar.")
                )
              )
            );
          })
        ...
        , tab==="care"&&(React.createElement(React.Fragment, null
          , !sp && (
            React.createElement('div', { style: {textAlign:"center",padding:40,color:C.muted},}
              , React.createElement('div', { style: {fontSize:36,marginBottom:12},}, "🌿")
              , React.createElement('div', { style: {fontWeight:700,color:C.soil,marginBottom:8},}, (getT().noCareData||"Geen verzorgingsdata") )
              , React.createElement('div', { style: {fontSize:13,lineHeight:1.5},}, "Tik op "  , React.createElement('strong', null, (getT().getLocation||"🌍 Ophalen op mijn locatie")    ), " op het Overzicht tabblad om verzorgingsdata op te halen."         )
            )
          )
          , sp&&(React.createElement(React.Fragment, null
          ...
          , [{icon:"☀️",label:(getT().sunlight||"Zonlicht"),val:`${sunlight.min}–${sunlight.max}u/dag · ${sunlight.type} · UV: ${sp.sunlight.uv}`},{icon:"🪨",label:(getT().soil||"Grond"),val:sp.soil},{icon:"🏺",label:(getT().pot||"Pot"),val:sp.pot},{icon:"🌿",label:(getT().chipFert||"Bemesting"),val:sp.fertilize},{icon:"↕️",label:"Repot",val:sp.repot},{icon:"🔬",label:(getT().propagation||"Vermeerdering"),val:sp.propagation},{icon:"⚠️",label:(getT().toxicity||"Giftigheid"),val:sp.toxicity}].map(({icon,label,val})=>(
          ...
          , React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:16},}
            , React.createElement('div', { style: {fontWeight:700,color:C.soil,marginBottom:10},}, (getT().proTips||"💡 Pro Tips")  )
            , sp.tips.map((tip,i)=>(
        ...
        , tab==="log"&&(React.createElement(React.Fragment, null
          ...
          , React.createElement('div', {style:{display:"flex",gap:6,flexWrap:"wrap",marginBottom:10}},
            [{id:"all",icon:"📋",label:(t.allFilter||"Alles")},{id:"water",icon:"💧",label:"Water"},
             {id:"pest",icon:"🦠",label:(getT().chipPest||"Plagen")},{id:"fertilizer",icon:"🌿",label:(getT().chipFert||"Bemesting")},
             {id:"growth",icon:"📏",label:"Groei"},{id:"custom",icon:"✏️",label:(getT().chipOther||"Overig")}
          ...
          , (() => {
            ...
            return (
              React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:14,marginBottom:12,
                boxShadow:C.shadowSm,border:`1px solid ${C.border}`},}
                , React.createElement('div', { style: {fontWeight:700,color:C.soil,fontSize:13,marginBottom:10},}, (getT().evolution||"📈 Evolutie over tijd")
                ...
                , heightPoints.length >= 2 && (
                  React.createElement('div', null
                    , React.createElement('div', { style: {fontSize:11,color:C.muted,marginBottom:4,fontWeight:600},}, (getT().heightIcon||"📏 Hoogte (cm)")
          ...
          , (() => {
            ...
            return (
              React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:14,marginBottom:12},}
                , React.createElement('div', { style: {fontWeight:700,color:C.soil,fontSize:13,marginBottom:8},}, (getT().waterLog30||"💧 Water gegeven — afgelopen 30 dagen")      )
                ...
                , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",fontSize:9,color:C.muted,marginTop:4},}
                  , React.createElement('span', null, "30d geleden" ), React.createElement('span', null, (getT().today2||"Vandaag"))
                )
                , React.createElement('div', { style: {marginTop:6,fontSize:12,color:C.muted},}
                  , waterLogs.length, (getT().waterCount||"× water gegeven in 30 dagen")
          ...
          , plantLogs.length===0
            ? React.createElement('div', { style: {textAlign:"center",padding:30,color:C.muted,fontSize:14},}, (getT().noEntries||"Nog geen entries.")
                  , React.createElement('br', null), (getT().useQuickLog||"Gebruik Snel Loggen op het Overzicht tabblad.")
              )
...
const searchGBIF = async (q) => {
  ...
  const KINGDOM_PLANTAE = 6; // GBIF kingdom key for Plantae
  const seen = new Set();
  const out = [];

  const isPlant = (s) => {
    // Accept only plants. GBIF returns kingdom/kingdomKey on search results.
    if (s.kingdom) return s.kingdom === "Plantae";
    if (s.kingdomKey != null) return s.kingdomKey === KINGDOM_PLANTAE;
    return true; // suggest endpoint omits kingdom — allow, verified later on select
  };

  const addResult = (s) => {
    const canonical = s.canonicalName || s.scientificName || s.species;
    if (!canonical || seen.has(canonical)) return;
    if (!isPlant(s)) return;
    seen.add(canonical);
    let common = canonical;
    const verns = s.vernacularNames || [];
    if (verns.length && verns[0].vernacularName) common = verns[0].vernacularName;
    else if (s.vernacularName) common = s.vernacularName;
    out.push({
      scientificName: canonical,
      commonName: common,
      family: s.family || "",
      fromDB: !!SPECIES_DB[canonical],
    });
  };

  try {
    // 1. Full-text search restricted to kingdom Plantae — matches scientific AND
    //    vernacular (common) names in every language GBIF has indexed, so Dutch
    //    "jeneverbes", German "Wacholder", French "genévrier" all resolve to Juniperus.
    const r = await fetch(
      `https://api.gbif.org/v1/species/search?q=${encodeURIComponent(q)}&highertaxon_key=${KINGDOM_PLANTAE}&rank=SPECIES&status=ACCEPTED&limit=25`
    );
    if (r.ok) {
    ...
    // 2. Suggest endpoint (fast prefix match on scientific names) — also plant-filtered.
    const r2 = await fetch(
      `https://api.gbif.org/v1/species/suggest?q=${encodeURIComponent(q)}&highertaxon_key=${KINGDOM_PLANTAE}&limit=25`
    );
    if (r2.ok) {
      const data2 = await r2.json();
      (Array.isArray(data2) ? data2 : data2.results || []).forEach(addResult);
    }
    if (out.length > 0) return out;

    // 3. Last resort: unfiltered search, then keep only Plantae client-side. Guards
    //    against the rare case where the taxon key filter drops a valid plant.
    const r3 = await fetch(
      `https://api.gbif.org/v1/species/search?q=${encodeURIComponent(q)}&rank=SPECIES&limit=25`
    );
    if (r3.ok) {
      const data3 = await r3.json();
      (data3.results || []).filter(s => s.kingdom === "Plantae").forEach(addResult);
    }
    return out;
  } catch (e) {
  ...
  return (
    React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:16,marginBottom:12,
      ...
      , React.createElement('button', { onClick: run, disabled: running,
        ...
        , running ? "Bezig..." : sources ? "🔄 Opnieuw ophalen" : (getT().getLocation||"🌍 Ophalen op mijn locatie")
      )
    )
  );
};
            ...
            React.createElement('div', null
              ...
              , React.createElement('div', { style: {display:"flex",gap:14,marginBottom:16,alignItems:"flex-start"},}
                , React.createElement('div', { style: {width:110,height:110,borderRadius:14,overflow:"hidden",background:C.surfaceAlt,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0,position:"relative"},}
                  ...
                  :(React.createElement('div', { style: {textAlign:"center"},}, React.createElement('div', { style: {fontSize:40},}, _optionalChain([sp, 'optionalAccess', _297 => _297.image])||"🌿"), React.createElement('div', { style: {fontSize:9,color:C.muted,marginTop:2},}, (t.noPhoto||"Geen foto") )))
                )
                , React.createElement('div', { style: {flex:1},}
              ...
              , sp&&(React.createElement('div', { style: {background:C.greenPale,borderRadius:10,padding:12,marginBottom:14},}
                ...
                , (()=>{const c=sp.care[getCurrentSeason()];return(
                  React.createElement('div', { style: {display:"flex",gap:8},}
                    , [{l:"Water",v:`elke ${c.water} dagen`,icon:"💧"},{l:"Humidity",v:`${c.humidity}%`,icon:"💦"},{l:(getT().sunlight||"Zonlicht"),v:`${sp.sunlight.min}–${sp.sunlight.max}h`,icon:"☀️"}].map(({l,v,icon})=>(
              ...
              , React.createElement('div', { style: {display:"flex",gap:10,paddingBottom:8},}
                , React.createElement(Btn, { onClick: onClose, outline: true, color: C.muted, fullWidth: true, disabled: enriching,}, (t.cancel||(t.cancel||(t.cancel||(t.cancel||"Annuleer")))))
    ...
    React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",zIndex:300,display:"flex",alignItems:"flex-end"},}
      , React.createElement('div', { style: {background:C.surface,borderRadius:"20px 20px 0 0",width:"100%",maxWidth:600,margin:"0 auto",maxHeight:"85vh",display:"flex",flexDirection:"column"},}
        ...
        , React.createElement('div', { style: {padding:"12px 20px",borderTop:`1px solid ${C.border}`},}
          , React.createElement(Btn, { fullWidth: true, onClick: ()=>{onSave(s);onClose();},}, (t.save||(t.save||(t.save||(t.save||"Opslaan")))))
        )
      )
    )
  );
      ...
      , !waterPaused && !bulkMode && d !== null && (
        React.createElement('div', { style: {borderTop:`1px solid ${d<=0?C.danger:d<=2?C.warning:C.border}`,
          ...
          , React.createElement('div', { style: {flex:1,fontSize:11,color:d<=0?C.danger:C.warning,fontWeight:600},}
            , d===null?"💧 Schema instellen":d<=0?(t.overdue?("⚠️ "+t.overdue+"!"):("⚠️ Water vergeten!")):d===1?(t.waterTomorrow||(getT().waterTmrw||"💧 Water morgen")):`💧 Over ${d} dagen`
          )
          , React.createElement('button', { onClick: handleQuickWater,
            ...
            , watered?(t.markWatered||(getT().waterGiven||"✓ Water gegeven")):(getT().waterGiven||"💧 Water gegeven")
          )
        )
      )
    ...
    React.createElement('div', { style: {position:"fixed",inset:0,background:"rgba(0,0,0,0.6)",zIndex:300,display:"flex",alignItems:"flex-end"},}
          ...
          , React.createElement('div', { style: {background:C.surfaceAlt,borderRadius:12,padding:14},}
            ...
            , React.createElement('label', null
              , React.createElement('div', { style: {width:"100%",padding:"10px",border:`1px dashed ${C.border}`,borderRadius:10,
                ...
                , importing ? "⏳ Bezig met importeren..." : (t.import||"📥 Kies backup bestand")
              )
      ...
      , d !== null && d <= 2 && (
        React.createElement('div', { style: {borderTop:`1px solid ${C.border}`,background:C.surfaceAlt,
          display:"flex",alignItems:"center",padding:"6px 12px",gap:8},}
          , React.createElement('div', { style: {flex:1,fontSize:11,color:d<=0?C.danger:C.warning,fontWeight:600},}
            , d<=0?(t.overdue?("⚠️ "+t.overdue+"!"):("⚠️ Water vergeten!")):(t.waterTomorrow||(getT().waterTmrw||"💧 Water morgen"))
          )
          , React.createElement('button', { onClick: handleQuickWater,
            style: {background:watered?C.green:d<=0?C.danger:C.warning,color:"#fff",
              border:"none",borderRadius:8,padding:"5px 12px",cursor:"pointer",
...
const SettingsScreen = ({
  ...
  const TABS = [
    {id:"general", icon:"⚙️", label:(getT().tabGeneral||"Algemeen")},
    {id:"taal", icon:"🌐", label:(getT().tabTaal||"Taal")},
    {id:"sections", icon:"📂", label:(getT().tabSections||"Afdelingen")},
    {id:"notif", icon:"🔔", label:(getT().tabNotif||"Meldingen")},
    {id:"data", icon:"💾", label:(getT().tabData||"Data")},
  ];
  ...
  return (
    React.createElement('div', { style: {minHeight:"100vh",background:C.bg,zIndex:200,fontFamily:"system-ui,sans-serif"},}
      ...
      , React.createElement('div', { style: {background:`linear-gradient(160deg, ${C.soil} 0%, ${C.soilLight} 100%)`,
        ...
        , React.createElement('div', { style: {display:"flex",alignItems:"center",gap:12,marginBottom:8},}
          , React.createElement('button', { onClick: ()=>{onSaveNotif(notif);onClose();}, className: "pca-btn",
            style: {background:"rgba(255,255,255,0.12)",border:"1px solid rgba(255,255,255,0.15)",
              ...
              borderRadius:10,fontFamily:"inherit",fontWeight:600},}, (t.back||(t.back||"← Terug"))
        ...
        , (tab==="overview") && React.createElement("div", {style:{fontSize:24,fontWeight:900,color:"#F5F1EB",letterSpacing:-0.3}}, (t.settings||"Instellingen"))
      ))
        /* Tab bar */
      ...
      , React.createElement('div', { style: {padding:"16px",maxWidth:600,width:"100%",margin:"0 auto",boxSizing:"border-box"},}
        ...
        , tab === "general" && (
          React.createElement('div', null
            ...
            , React.createElement('div', {style:{display:"flex",alignItems:"center",justifyContent:"space-between"}}
              , React.createElement('div', null
                , React.createElement('div', {style:{fontWeight:700,color:C.soil,fontSize:14}}, (t.darkMode||"🌙 Weergave"))
                , React.createElement('div', {style:{fontSize:12,color:C.muted,marginTop:2}},
                    darkMode ? (t.darkModeOn||"Donkere modus actief") : (t.lightModeOn||"Lichte modus actief"))
              )
              , React.createElement('div', {style:{display:"flex",gap:6}}
            ...
            , (()=>{
              ...
              return React.createElement('div', {style:{background:C.surface,borderRadius:14,padding:14,marginBottom:12,
                ...
                , React.createElement('div', {style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}
                  , React.createElement('div', null
                    , React.createElement('div', {style:{fontWeight:700,color:C.soil,fontSize:14}}, (t.vacation||"🏖️ Vakantie-modus"))
                    , React.createElement('div', {style:{fontSize:12,color:vac.active?C.warning:C.muted,marginTop:2}},
                        vac.active ? (startText&&endText ? startText+' → '+endText+' (nog '+daysLeft+' dag'+(daysLeft!==1?'en':'')+')' : 'Actief — nog '+daysLeft+' dag'+(daysLeft!==1?'en':'')) : (t.vacationDesc||"Pauzeer waterschema's tijdens afwezigheid"))
                  )
                  , React.createElement('button', {
                      ...
                      vac.active?"Deactiveer":(t.vacationActivate||"Activeer"))
                )
                , !vac.active && React.createElement('div', {style:{display:"flex",flexDirection:"column",gap:8}}
                  , React.createElement('div', {style:{display:"flex",gap:8,alignItems:"center"}}
                  , React.createElement('div', {style:{flex:1}}
                    , React.createElement('div', {style:{fontSize:11,color:C.muted,marginBottom:4,fontWeight:600}}, (t.from||"VAN"))
                    , React.createElement('input', {
                  ...
                  , React.createElement('div', {style:{flex:1}}
                    , React.createElement('div', {style:{fontSize:11,color:C.muted,marginBottom:4,fontWeight:600}}, (t.to||"TOT"))
                    , React.createElement('input', {
                  ...
                  , React.createElement('input', {
                      value:vac.caretaker||"",placeholder:(t.caretaker||"Naam verzorger (optioneel)"),
                  ...
                  , React.createElement('textarea', {
                      value:vac.notes||"",placeholder:(t.caretakerNotes||"Extra notities voor de verzorger..."),rows:2,
                ...
                , vac.active && React.createElement('button', {
                    ...
                    (t.pdfCaretaker||"📄 PDF genereren voor verzorger"))
              );
            })()
            ...
            , (()=>{
              ...
              return (
                React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:14,marginBottom:12,
                  ...
                  , React.createElement('div', { style: {fontWeight:700,color:C.soil,marginBottom:4,fontSize:14},}, (t.aiAdvisor||"🤖 AI Plant Adviseur")   )
            ...
            , React.createElement('div', { style: {background:C.surface,borderRadius:14,overflow:"hidden",marginBottom:12},}
              , React.createElement('button', {
                ...
                (t.dataTab||"💾 Data exporteren / importeren"),
        ...
        , tab === "data" && (
          React.createElement('div', null
            ...
            , React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:14,marginBottom:12,border:`1px solid ${C.border}`}}
              ...
              , React.createElement('label', null
                , React.createElement('div', { style: {width:"100%",padding:"11px",border:`1px dashed ${C.border}`,borderRadius:10,
                  ...
                  importing?(t.importing||"⏳ Importeren..."):(t.import||"📥 Kies backup bestand"))
                , React.createElement('input', { type:"file", accept:".json", onChange:handleImport,
                    disabled:importing, style:{display:"none"}})
              )
            )
            ...
            , React.createElement('div', { style: {background:C.surface,borderRadius:14,padding:14,marginBottom:12,border:`1px solid ${C.border}`}}
              ...
              , React.createElement('div', { style: {marginTop:16,paddingTop:14,
                  borderTop:`1px solid ${C.border}`,textAlign:"center"},}
                , React.createElement('div', { style: {fontSize:13,fontWeight:700,color:C.soil},}
                  , "Plant Care App"
                )
                , React.createElement('div', { style: {fontSize:12,color:C.muted,marginTop:2},}
                  , (getT().versionLabel||"Versie")+" "+APP_VERSION+" · build "+APP_BUILD
                )
              )
            )
...
const Dashboard = ({plants, logs, sections, estates, activeEstate, onSelectPlant, onAddPlant, onDeletePlant, onOpenSettings, onOpenCalendar, onQuickWater, t, bulkMode, selectedPlants, onToggleBulk, onBulkWater, onBulkMove, allSections, onOpenScanner, vacation}) => {
    ...
    React.createElement('div', { style: {minHeight:"100vh",background:C.bg,fontFamily:"system-ui,sans-serif",paddingBottom:80},}
      ...
      , React.createElement('div', { style: {background:`linear-gradient(160deg, ${C.soil} 0%, ${C.soilLight} 60%, #3A2E1A 100%)`,
        ...
        , React.createElement('div', { style: {display:"flex",justifyContent:"space-between",alignItems:"flex-start",position:"relative"},}
          , React.createElement('div', null
            , React.createElement('div', { style: {fontSize:10,color:C.sand,letterSpacing:3,textTransform:"uppercase",
              ...
              , React.createElement('span', null, ({spring:(getT().spring||"Lente"),summer:(getT().summer||"Zomer"),autumn:(getT().autumn||"Herfst"),winter:(getT().winter||"Winter")}[season]||season.charAt(0).toUpperCase()+season.slice(1)), " " , new Date().getFullYear())
            )
            ...
            , React.createElement('div', { style: {fontSize:26,fontWeight:900,color:"#F5F1EB",letterSpacing:-0.5,lineHeight:1.1},}, (t.myPlants||"Planten")
            ...
            , React.createElement('div', { style: {fontSize:12,color:C.greenLight,marginTop:4,fontWeight:500,
              ...
              , React.createElement('button', { onClick: onOpenSettings,
                ...
                , _optionalChain([t, 'optionalAccess', _322 => _322.switchLocation])||(t.switchLocation||"+ Locatie wisselen")
              )
            )
          )
          , React.createElement('div', { style: {display:"flex",gap:8,marginTop:4},}
            ...
            , React.createElement('button', { onClick: onOpenCalendar, className: "pca-btn",
              style: {background:"rgba(255,255,255,0.12)",border:"1px solid rgba(255,255,255,0.15)",
        ...
        , React.createElement('div', { style: {display:"flex",gap:8,marginTop:16,position:"relative"},}
          , [
            {label:_optionalChain([t, 'optionalAccess', _323 => _323.waterNow])||(t.waterNow||"Water nu"),val:urgent.length,color:urgent.length?"#FF8A80":C.greenLight,
             bg:urgent.length?"rgba(184,92,66,0.25)":"rgba(255,255,255,0.08)",
             icon:"💧"},
            {label:_optionalChain([t, 'optionalAccess', _324 => _324.soon])||(t.soon||"Binnenkort"),val:soon.length,color:soon.length?"#FFD54F":C.greenLight,
             bg:soon.length?"rgba(212,150,14,0.2)":"rgba(255,255,255,0.08)",
             icon:"⏳"},
            {label:_optionalChain([t, 'optionalAccess', _325 => _325.avgHealth])||(t.avgHealth||"Gem. gezondheid"),
          ...
          , selectedPlants.length > 0 && (React.createElement(React.Fragment, null
            , React.createElement('button', { onClick: onBulkWater, className: "pca-btn",
              style: {background:C.sky,border:"none",borderRadius:10,padding:"7px 14px",
                cursor:"pointer",color:"#fff",fontSize:12,fontWeight:700,fontFamily:"inherit"},}, (getT().waterGiven||"💧 Water gegeven")
      ...
      , React.createElement('div', { style: {padding:"0 16px",maxWidth:600,margin:"0 auto"},}
        /* Calendar moved to dedicated tab */
            ...
            , urgent.map(p=>(
              React.createElement('div', { key: p.id, onClick: ()=>onSelectPlant(p),
                ...
                , React.createElement('span', { style: {marginLeft:"auto",fontSize:11,fontWeight:700,color:C.terracotta},}
                  , daysUntil(p.nextWater)<=0?"⚠️ Te laat":(getT().today2||"Vandaag")
                )
              )
            ))
          )
        ...
        , vacation && vacation.active && React.createElement('div', {
          ...
          , React.createElement('div', { style: {display:"flex",background:C.surfaceAlt,borderRadius:10,padding:2,gap:1},}
            , [{id:"section",icon:"📂",label:(t.filterSection||"Afdeling")},{id:"category",icon:"🌿",label:(t.filterCategory||"Categorie")}].map(m=>(
        ...
        , filterMode === "section" ? (
          ...
          React.createElement('div', { style: {display:"flex",gap:6,overflowX:"auto",paddingBottom:4,marginBottom:10},}
            , [(t.filterAll||"Alle"),...usedCats].map(cat=>(
...
function PlantCareApp() {
  ...
  const activeEstate = estates.find(e=>e.id===activeEstateId) || estates[0] || {name:(t.appTitle||"Mijn Planten"),icon:"🌿"};
  ...
  const addPlant=useCallback(p=>{
    ...
    // Auto-fetch location-aware care data in background on first add
    if (p.species && p.species !== "Eigen soort" && p.species !== "Custom species") {
      fetchLocationAwareCareData(
        p.species,
        p.commonName || p.species,
        p.family || "",
        () => {} // silent progress
      ).then(result => {
        if (result && result.care) {
          // Care data is stored in SPECIES_DB (module-level cache) — no plant update needed
          // Force a re-render so the care tab populates
          setPlants(prev => prev.map(x => x.id === p.id ? {...x, _careLoaded: Date.now()} : x));
        }
      }).catch(() => {}); // silent fail — user can always manually refresh
    }
  },[]);
  ...
  return(React.createElement(React.Fragment, null
    ...
    , showCalendar && React.createElement(CalendarScreen, {
          plants: plants,
          sections: activeRooms,
          onSelectPlant: (id)=>{ setShowCalendar(false); setSelectedId(id); },
