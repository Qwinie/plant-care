      ...
      , React.createElement('div', { style: {padding:"16px",maxWidth:600,width:"100%",margin:"0 auto",boxSizing:"border-box"},}
        ...
        , tab === "data" && (
          ...
          , React.createElement('div', {style:{background:C.surface,borderRadius:14,padding:14,marginBottom:12,
            ...
            , React.createElement('div', {style:{fontSize:13,color:C.muted,marginBottom:12,lineHeight:1.5}},
              "Verwijder alle planten, logs en instellingen. Dit kan niet ongedaan worden gemaakt.")
            , React.createElement('button', {
                onClick:()=>{
                  if(window.confirm("Weet je zeker dat je ALLE data wilt verwijderen? Dit kan niet ongedaan worden gemaakt.")) {
                    const keys = Object.keys(localStorage).filter(k=>k.startsWith("plantcare"));
          ...
          , React.createElement('div', {style:{background:C.surface,borderRadius:14,padding:14,marginBottom:12,
            ...
            , React.createElement('div', {style:{fontSize:13,color:C.muted,marginBottom:10,lineHeight:1.5}},
              "Plant Care slaat alle data uitsluitend op je eigen apparaat op. Geen accounts, geen tracking.")
            , React.createElement('button', {
            ...
            , showPrivacy && React.createElement('div', {
                style:{marginTop:12,maxHeight:400,overflowY:"auto",borderRadius:10,
                  ...
                  fontSize:13,lineHeight:1.8,color:C.text,WebkitOverflowScrolling:"touch"}},
                ...
                React.createElement('p', {style:{marginBottom:12}},
                  "Plant Care slaat alle gegevens uitsluitend op je eigen apparaat op via localStorage. Er worden geen persoonsgegevens verzameld, geen accounts aangemaakt en geen data naar externe servers gestuurd."),
                React.createElement('h4', {style:{color:C.green,marginBottom:6,marginTop:12}}, "Welke gegevens worden lokaal opgeslagen?"),
                React.createElement('p', {style:{marginBottom:8}}, "Uitsluitend op je eigen telefoon:"),
                React.createElement('ul', {style:{paddingLeft:20,marginBottom:12}},
                  React.createElement('li', {style:{marginBottom:4}}, "Plantnamen, soorten en foto's die je zelf invoert"),
                  React.createElement('li', {style:{marginBottom:4}}, "Waterschema's en verzorgingslogs"),
                  React.createElement('li', {style:{marginBottom:4}}, "Locaties en ruimtes die je aanmaakt"),
                  React.createElement('li', {style:{marginBottom:4}}, "App-instellingen en taalvoorkeur")
                ),
                React.createElement('h4', {style:{color:C.green,marginBottom:6,marginTop:12}}, "Optionele externe diensten"),
                React.createElement('p', {style:{marginBottom:8}}, "De app maakt optioneel gebruik van:"),
                React.createElement('ul', {style:{paddingLeft:20,marginBottom:12}},
                  React.createElement('li', {style:{marginBottom:4}},
                    React.createElement('strong', null, "Claude AI (Anthropic)"),
                    " — voor de AI Plant Adviseur. Alleen je vraag en plantnaam worden verstuurd. Geen persoonsgegevens."),
                  React.createElement('li', {style:{marginBottom:4}},
                    React.createElement('strong', null, "Wikipedia / iNaturalist / Open-Meteo"),
                    " — voor plantinfo en weersdata. Publieke API's zonder authenticatie."),
                  React.createElement('li', {style:{marginBottom:4}},
                    React.createElement('strong', null, "ASPCA.org"),
                    " — voor live giftigheidsdata. Alleen de plantsoort wordt verstuurd.")
                ),
                React.createElement('h4', {style:{color:C.green,marginBottom:6,marginTop:12}}, "Camera"),
                React.createElement('p', {style:{marginBottom:12}},
                  "De camera wordt gebruikt voor de lichtmeter en QR-scanner, alleen als je dit zelf activeert. Er worden geen foto's opgeslagen of verstuurd door deze functies."),
                React.createElement('h4', {style:{color:C.green,marginBottom:6,marginTop:12}}, "Gegevens verwijderen"),
                React.createElement('p', {style:{marginBottom:12}},
                  "Alle app-data verwijder je onderaan deze pagina via de rode knop 'Wis alle data', of door de app-opslag te wissen via je telefooninstellingen."),
                React.createElement('h4', {style:{color:C.green,marginBottom:6,marginTop:12}}, "Contact"),
                React.createElement('p', {style:{marginBottom:4}},
                  "Vragen? Maak een issue aan op ",
                  React.createElement('span', {
                    style:{color:C.sky,textDecoration:"underline",cursor:"pointer"},
                    onClick:()=>window.open("https://github.com/Qwinie/plant-care")},
                    "github.com/Qwinie/plant-care")),
                React.createElement('div', {style:{borderTop:`1px solid ${C.border}`,marginTop:16,paddingTop:16}},
                  React.createElement('button', {
                    onClick:()=>{
                      if(window.confirm("Weet je zeker dat je ALLE data wilt verwijderen? Dit kan niet ongedaan worden gemaakt.")) {
