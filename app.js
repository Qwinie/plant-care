  ...
  return(
    React.createElement('div', { style: {position:"fixed",inset:0,background:C.bg,zIndex:200,fontFamily:"system-ui,sans-serif",overflowY:"auto",WebkitOverflowScrolling:"touch"},}
      ...
      , React.createElement('div', { style: {padding:16,maxWidth:600,margin:"0 auto",paddingBottom:40},}
        ...
        React.createElement("div", {style:{display:"flex",alignItems:"center",gap:8,padding:"14px 4px 4px",marginTop:4}}, React.createElement("div", {style:{width:3,height:14,background:"#6D5D4C",borderRadius:2}}), React.createElement("span", {style:{fontSize:10,fontWeight:800,color:"#6D5D4C",letterSpacing:1,textTransform:"uppercase"}}, (getT().healthPhotos||"❤️ Gezondheid + Fotos"))),
        React.createElement(CollapsibleCard, {
            ...
            /* ── Quick log ── */
            , React.createElement(CollapsibleCard, { icon: "📝", title: (t.quickLog||(t.quickLog||"Snel loggen")) , defaultOpen: true,}
            ...
            /* ── Temperature ── */
            , React.createElement(CollapsibleCard, { icon: "🌡️", title: (getT().secTemperature||"Temperatuur"), defaultOpen: false,}
              , sp ? (
            ...
            , React.createElement(CollapsibleCard, { icon: "📍", title: (getT().secLocation||"Locatie & afdeling")  , defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            /* ── Care events ── */
            , React.createElement(CollapsibleCard, { icon: "⚡", title: (getT().secEvents||"Uitzonderlijke verzorging") ,
            ...
            /* ── Custom reminders ── */
            , React.createElement(CollapsibleCard, { icon: "⏰", title: (getT().secReminders||"Eigen herinneringen") ,
            ...
            /* ── Repotting ── */
            , React.createElement(CollapsibleCard, { icon: "🏺", title: (getT().secRepot||"Verpotten"),
            ...
            /* ── Licht meter ── */
            , React.createElement(CollapsibleCard, { icon: "☀️", title: (getT().secLight||"Lichtmeter"),
              defaultOpen: false,
            ...
            , React.createElement(CollapsibleCard, { icon: "🌍", title: (getT().secLocationData||"Locatie-bewuste verzorgingsdata") , defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            /* ── Photos ── */
            , React.createElement(CollapsibleCard, { icon: "📷", title:`${getT().secPhotos||"Foto's"} (${(plant.photos||[]).length})`,
            ...
            /* ── Soil mix ── */
            , React.createElement(CollapsibleCard, { icon: "🏺", title: (getT().secSoil||"Grondmengsel"),
            ...
            /* ── Custom care values ── */
            , React.createElement(CollapsibleCard, { icon: "⚙️", title: (getT().secCustomCare||"Eigen verzorgingswaarden") , defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
            ...
            /* ── Danger zone ── */
            /* ── QR code ── */
            , React.createElement(CollapsibleCard, { icon: "📱", title: (getT().secQR||"QR-code"), defaultOpen: false,}
              , React.createElement('div', { style: {paddingTop:12},}
  ...
  return (
    React.createElement('div', { style: {minHeight:"100vh",background:C.bg,zIndex:200,fontFamily:"system-ui,sans-serif"},}
      ...
      , React.createElement('div', { style: {background:`linear-gradient(160deg, ${C.soil} 0%, ${C.soilLight} 100%)`,
        ...
        , React.createElement("div", {style:{fontSize:24,fontWeight:900,color:"#F5F1EB",letterSpacing:-0.3}}, (t.settings||"Instellingen"))
      ))
        /* Tab bar */
